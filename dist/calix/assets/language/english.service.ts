...
export class EnglishJSON {
  ...
  data = {
    ...
    //
    //pon to bip
    "BIP Error Interfaces By Region": "BIP Error Interfaces By Region",
    "BIP Error Interfaces By Location": "BIP Error Interfaces By Location",
    "BIP Error Interfaces By System": "BIP Error Interfaces By System",
    "Interfaces with BIP Errors": "Interfaces with BIP Errors",
    'PON Interface Count': 'PON Interface Count',
    'BIP Error Interfaces': 'BIP Error Interfaces',
    "Upstream Pon Errors": "Upstream BIP Error Count",
    "Downstream Pon Errors": "Downstream BIP Error Count",
    "Upstream BIP Error Count": "Upstream BIP Error Count",
    "Downstream BIP Error Count": "Downstream BIP Error Count",
    "Upstream PON Error": "Upstream PON Errors",
    "Downstream PON Error": "Downstream PON Errors",
    HBIPErrorbyregion: "BIP Error By Region",
    'BIP Error Count': 'BIP Error Count',
    "HBIPErrorByLocation": "BIP Error By Location",
    "HBIPErrorBySystem": "BIP Error By System",
    "HBIPErrorByInterface": "BIP Error By Interface",
    HBIPErrorRateByOnt: "BIP Error Rate By ONT",
    'BIP Errors': 'BIP Errors',
    'ONTs With BIP Error': 'ONTs With BIP Error',
    'BIP Error Rate By Timeseries': 'BIP Error Rate By Timeseries',
    'BIP Error By Timeseries': 'BIP Error By Timeseries',
    PON_BIP_Sub: 'Select a interface to view BIP errors on that interface',
    Ont_Bip_Sub: "Select an ONT to view BIP errors for that ONT",
    ...
    'Bip Error By Ont': 'BIP Error By ONT',
    TOTAL_PONS: 'Total PONs',
    PON_CAPACITY_HITS: 'PON Capacity Hits',
    'PON Interface Timeseries': 'BIP Interface Timeseries',
    "PON Health By Timeseries": "BIP Health By Timeseries",
    //
    ...
    Facebook_API_Expired_Msg: 'Facebook engagement channel error . Regenerate the API key to reconfigure the channel.',
    ...
    Mailchimp_Marketing_Channel_Configuration: 'Mailchimp Engagement Channel Configuration',
    HubSpot_Marketing_Channel_Configuration: ' HubSpot Engagement Channel Configuration',
    Audience: 'Audience',
    ...
    selectexist: 'Select existing Mailchimp audience to have Engagement Cloud add tags for targeted campaigns',
    ...
    success_configured: 'Mailchimp Engagement Channel has been successfully configured.',
    success_configured_face: 'Facebook Engagement Channel has been successfully configured.',
    success_configured_HubSpot: 'To complete HubSpot engagement channel setup,',
    ...
    Timeframe: 'Timeframe',
    MailChimp_Marketing_Channel_Results: 'Mailchimp Engagement Channel Results',
    HubSpot_Marketing_Channel_Results: 'HubSpot Engagement Channel Results',
    HubSpot: 'HubSpot',
    SEGMENT: 'Segment',
    ...
    Mailchimp: 'Mailchimp',
    electronic_content_mail: 'Electronic Content Builder can help you to design your collateral for use in',
    ...
    searchError:
      'Please narrow down your search. Entries after page 1000 are not showing',
    ...
    Constant_Contact_Search_Title: 'Constant Contact Engagement Channel Results',
    Constant_Contact_Config_Title: 'Constant Contact Engagement Channel Configuration',
    ...
    'Edit CommandIQ Email(s)': 'Edit CommandIQ Email(s)',
    'Edit CommandIQ Biz Email(s)': 'Edit CommandWorx Email(s)',
    'Primary CommandIQ Email': 'Primary CommandIQ Email',
    'Primary CommandIQ Biz Email': 'Primary CommandWorx Email',
    'Primary Email': 'Primary Email',
    'Secondary Email': 'Secondary Email',
    'confirm_msg_commandIQ_edit': 'I confirm that the subscriber has verified their identity and understand my access will be logged',
    ...
    Check_box_block:
      'Check The boxes to block content type(s). Uncheck the boxes to allow content type(s).',
    Gambling: 'Gambling',
    Social_Network: 'Social Network',
    Srch_appln:
      'Search for the Application you want to allow. select Duration to limit usage of this app to a specific amount of time per day',
    Block: 'Block',
    Always: 'Always',
    ...
    EXOS_Systems:
      'For EXOS Systems (version 20.3 or higher) and Gigafamily (version 12.2.11 or higher) use FSAN. For other system use Serial Number. Enter either a single System ID or multiple Serial Numbers separated using a comma, space or new line',
    Action: 'Action',
    ...
    GigaSpire_desc:
      '(GigaSpire version 20.3 or higher and GigaCenter version 12.2.11 or higher)',
    Plan_Desc:
      'If you plan to submit these results to the FCC, you need to be sure that the path to this test server is consistent with the requirements set out by the FCC for this testing.',
    ...
    'PIQ/EIQ Settings': 'PIQ/EIQ Settings',
    ...
    //service-wizard
    Service_config:
      'Service configuration is not available in Mesh(SAT) mode.  All services configured on the RG will pass through.',
    Service_config_Modem:
      'Service configuration is not available in Modem mode',
    ...
    Registered_Exos:
      'Registration ID is supported only for GigaCenters, GigaHubs & EXOS',
    Prev: 'Prev',
    Remove: 'Remove',
    ...
    Before_Del:
      'Before deleting the system, please make sure the system is disconnected, otherwise it will keep trying to reconnect.',
    Del_assoc:
      'This operation will delete all information associated with the system, including service provisioning.',
    ...
    //marketing-campaigns
    New: 'New',
    Marketing_Channels: 'Engagement Channels',
    Duplicate: 'Duplicate',
    ...
    Insightcsc_speedtest: 'Speed Test Minutes:',
    GB: 'GB',
    ...
    Edit: 'Edit',
    Add_Mrktng_Channel: 'Add Engagement Channel',
    ...
    experienceiq_protectiq_report_ar: 'subscribers-with-managed-services',
    ...
    new_subscribers_by_service_tier_technology:
      'new-subscribers-by-service-tier-technology',
    ...
    //marketing-insights
    Support_Insights: 'Support Insights',
    Marketing_Insights: 'Engagement Insights',
    ...
    competitorcsc_insight: 'Speed Test Minutes',
    ...
    Data_Usage_Trends: 'Data Usage Trends',
    Household_Device_Trends: 'Household Device Trends',
    Marketing_Campaigns: 'Engagement Campaigns',

    //marketing-campaign-channel
    Select_Mrktng_Channel: 'Select Engagement Channel',
    ...
    //blcok page view
    Block_pg_msg:
      'This page has been blocked. Please check the parental control or security settings in your router.',
    ...
    RemovSat_Msg:
      'Please remove the Satellite(s) before removing the Main Router',
    Update: 'Update',
    ...
    Serv_confg_wap:
      'Service configuration is not available in Mesh(SAT) mode. All services configured on the RG will be applied to the Mesh(SAT)',
    ...
    adoption_Chart: 'Subscribers with Managed Services',
    ...
    popup_content1:
      'Provides the number of times the subscribers downstream traffic usage reaches 90% of the max service rate.',
    popup_content2:
      'Provides the minutes visiting the speed test website from Ookla in the last time period selected (30 days, month, or 2 months).',
    popup_content3:
      'Provides the minutes in the last time period that the subscriber spent visiting a competitors website.',
    ...
    new_subscribe_popup1:
      'This widget shows the distribution of new subscribers among the service tiers and technology types.',
    new_subscribe_popup2: 'Get started with these quick tips:',
    new_subscribe_popup3:
      'Hover over the bars to get subscriber counts per service tier and the percentage per technology type.',
    new_subscribe_popup4:
      'Click the bars to display detailed subscriber information in the service tier and technology type.',
    ...
    new_revenue_popup1:
      'The month-to-month acquisition revenue and potential opportunities in the same bar graph.',
    new_revenue_popup2: 'Get started with these quick tips:',
    new_revenue_popup3:
      'Hover over the bars to get the current revenue and potential revenue.',
    new_revenue_popup4:
      'Click the bars to maximize the widget and display detailed subscriber information.',
    new_revenue_popup5:
      'Click the arrow next to a subscriber to retrieve an individual subscriber’s behavior/experience since becoming a customer, including data for Subscriber Revenue, Subscriber Usage, Usage by Application, Service Limits, Devices and Wi-Fi Score Trend, and Top Applications.',
    new_revenue_popup6:
      'Click the Export Options icon (upper right) to display options:',
    ...
    new_rate_popup1:
      'The monthly acquisition rate per tier for the last 6 months, including the individual subscriber’s behavior/experience.',
    new_rate_popup2: 'Get started with these quick tips:',
    new_rate_popup3:
      'Hover over the bars to get counts on acquired subscribers, total acquired subscribers, and existing subscribers per time frame.',
    new_rate_popup4:
    ...
    // churn risk
    churn_risk_popup1:
      'This widget identifies all subscribers who may churn in the next 3 months with a 50% or higher confidence level, categorized by High, Medium, and Low confidence scores.',
    churn_risk_popup2: 'Get started with these quick tips:',
    churn_risk_popup3:
      'Update the Region, Location, and time frame, if desired.',
    churn_risk_popup4:
      'Click the Export Data icon (upper right) to download the subscriber list',
    churn_risk_popup5:
      'Click the Close icon (upper right) to return to the dashboard.',
    // Retention
    retention_popup1:
    ...
    churn_rate_popup5:
      'Update the Region, Location, and time frame, if desired.',
    churn_rate_popup6:
      'Click the arrow next to a subscriber to view a specific dashboard with Subscriber Usage, Service Limits, Competitor Visit and Speed Test Minutes, Devices and Wi-Fi Score Trend, and Service Tier Change Events.',
    churn_rate_popup7:
      'Click the Export Options icon (upper right) to display options:',
    ...
    churn_rate_popup14:
      'Download the historical detail for each subscriber from chart selection.',
    churn_rate_popup15:
      'Download the historical detail from selected subscriber.',
    // Application
    // Usage by Application Type
    app_type_popup1:
      'This widget shows the distribution of subscribers by application type.',
    app_type_popup2: 'Get started with these quick tips:',
    app_type_popup3:
      'Hover over a pie chart area to get subscriber counts and total usage.',
    app_type_popup4:
      'Click a pie chart area to display a list of applications with usage, percentage of usage, average number of subscribers, and average percentage of subscribers.',
    ...
    // Top Applications
    top_app_popup1:
      'This widget shows the top 10 applications used by the subscribers with the average subscriber count and percentage.',
    top_app_popup2: 'Get started with these quick tips:',
    top_app_popup3:
      'Click the applications to display the subscriber count and percentage for each day.',
    ...
    gaming_app_popup1:
      'This widget shows the top 10 gaming applications used by the subscribers with the average subscriber count and percentage.',
    gaming_app_popup2: 'Get started with these quick tips:',
    gaming_app_popup3:
      'Click the gaming applications to display the subscriber count and percentage for each day.',
    gaming_app_popup4:
      'Update the Region, Location, and time frame, if desired.',
    gaming_app_popup5:
      'Click the Export Options icon (upper right) to display options:',
    ...
    gaming_app_popup10:
      'Download the daily subscriber count for an application.',
    // Social Channel Heatmap
    social_channel_popup1:
      'This widget shows a heatmap of subscribers by social channels, enabling you to determine which social channel and time of day is best to target for maximum return in engagement spend.',
    social_channel_popup2: 'Get started with these quick tips:',
    social_channel_popup3:
      'From the drop-down, select a social channel and hover over an area to get a percentage of subscribers and hours. (The widget displays data from the last 30 days.)',
    ...
    household_popup1:
      'This widget shows a comparative monthly trend in average home device count and Wi-Fi score.',
    household_popup2: 'Get started with these quick tips:',
    household_popup3:
      'Hover over the lines to get Average Home Device Count or Wi-Fi Score per time frame.',
    household_popup4:
      'Update the Region, Location, and time frame, if desired.',
    household_popup5:
      'Click the Export Data icon (upper right) to download data displayed on the chart.',
    ...
    service_module_popup1:
      'This widget shows ExperienceIQ and ProtectIQ trend over last 6 months.',
    ...
    wifi_popup1:
      'This widget shows the total number of subscribers using GigaFamily devices and the device count per subscribers.',
    wifi_popup2: 'Get started with these quick tips:',
    wifi_popup3:
      'Hover over the bars to get the number of subscribers for the device count range.',
    wifi_popup4:
      'Click the bars to display detailed subscriber information for device count range.',
    ...
    //  CommandIQ Insights
    commandiq_popup1:
      'This widget provides insights into candidates for upsell of CommandIQ products and services, including Gigaspire devices. CommandIQ Insights are sorted by the number of devices followed by their upstream usage. Subscribers at the top of the list have the most connected devices.',
    ...
    stream_sub_popup1:
      'This widget shows the total streaming subscribers vs. non-streaming subscribers for each service tier. Streaming Subscribers include the number of subscribers who consume the equivalent of 1G per day for the selected period of days worth of streaming video.',
    ...
    wfh_popup2:
      'This widget shows the total number of WFH subscribers and non-WFH subscribers for each service tier. WFH Subscribers includes the number of subscribers who use WFH connection at least an average of 80 minutes per day.',
    ...
    subs_act_popup1:
      'This widget shows a comparative monthly trend in streaming, Wfh, and gaming subscribers.',
    subs_act_popup2: 'Get started with these quick tips:',
    subs_act_popup3:
      'Hover over the lines to get total subscriber count per time frame.',
    ...
    // Data Usage Trends
    data_usg_popup1:
      'This widget shows a comparative usage monthly trend in total bandwidth usage vs. streaming usage over time.',
    data_usg_popup2: 'Get started with these quick tips:',
    data_usg_popup3:
      'Hover over the lines to get the total usage or streaming usage per time frame.',
    ...
    //Block threat
    block_popup1:
      'This widget shows the distribution of blocked threats by categories',
    ...
    subs_fullscreen_content:
      'The distribution of subscribers by consumed bandwidth.',
    subs_fullscreen_close_tip: 'Dismiss',
    Streaming_Show_Tittle:
      'The total streaming subscribers vs. non-streaming subscribers for each service tier.',
    Gaming_Show_Title:
      'The total gaming subscribers and non-gaming subscribers for each service tier.',
    WFH_Show_Title:
      'The total WFH subscribers and non-WFH subscribers for each service tier.',
    activity_Show_Title:
      'A comparative monthly trend in streaming,WFH and gaming subscribers',
    usage_Show_Title:
      'A comparative usage monthly trend in bandwidth usage vs. streaming usage over time.',
    DevicePerHousehold_Info:
      'The total number of subscribers using GigaFamily devices and the device count per subscribers.',
    serviceTier_content_tip:
      'The distribution of subscribers among the service tiers and technology types.',
    HouseholdOptions_Info:
      'A comparative monthly trend in average home device count and Wi-Fi score.',
    ServiceModuleAdoptionRate_Info:
      'ExperienceIQ and ProtectIQ trend over last 6 months.',
    ...
    AcquisitionRevenueAndInsights_Info:
      'Acquisition revenue and insights for the last 6 months.',
    UsageByApplication_Info:
      'The distribution of subscribers by application type.',
    TopApp_Info:
      'The top 10 applications used by the subscribers with the average subscriber count and percentage.',
    TopGamingApp_Info:
      'The top 10 gaming applications used by the subscribers with the average subscriber count and percentage.',
    Heat_Map_ShowInfo:
      'A heatmap of subscribers by social channels, enabling you to determine which social channel and time of day is best to target for maximum return in engagement spend.',
    explort_option: 'Export Options',
    AcquisitionRateAndInsights_Info:
      'Acquisition rate and insights for the last 6 months.',
    serviceTierNew_content_tip:
      'The distribution of new subscribers among the service tiers and technology types.',
    //venkatesh v2 end
    ...
    Retention_Info:
      'Data on subscriber behavior and the overall subscriber service experience.',
    ...
    WFH_Info:
      'The total number of WFH subscribers and non-WFH subscribers for each service tier.',
    ...
    AcquisitionTotalAcquiredLastSixmonths:
      'Total Acquired in the Last Six Months',
    AcquisitionJoyride1stInfo:
      'Chart displays information on which customers have added a new broadband service on a monthly basis (6 month max trend).',
    ...
    AcquisitionRevenueStep35Content1:
      'Chart displays information on the monthly revenue added from new subscribers and the maximum potential revenue from those same subscribers.',
    AcquisitionRevenueStep35Content2:
      ' Max Potential Revenue is calculated based on the attainable rate for each subscriber and the maximum revenue that could be achieved based on that attainable rate.',
    AcquisitionRevenueStep36Content1:
      'Max Potential Revenue displays the highest revenue that could have come from new subscribers.',
    AcquisitionRevenueStep36Content2:
      'Actual Revenue displays the monthly revenue from new subscribers.',
    //New Technology
    ...
    DataUsageTrends_Info:
      'A comparative usage monthly trend in total bandwidth usage vs. streaming usage over time.',
    ...
    BlockedThreats_Walkthrough1:
      'For subscribers with Whole Home Network Protection services (ProtectIQ) enabled, insight can be exposed about the type(s) of threats that have been blocked.',
    BlockedThreats_Walkthrough2:
      'The categories displayed align to threats blocked in the CommandIQ mobile app, including:',
    BlockedThreats_Walkthrough3:
      'Intrusions detected to the subscriber network',
    WebThreats: 'Web Threats (malware attacks)',
    BlockedThreats_Walkthrough4:
      'This information can be used to articulate the value of the ProtectIQ solution directly to your subscribers.',
    ...
    competitorQuesMark:
      'Monthly minutes spent on speed tests and competitor websites',
    ...
    eventsSertchPlaceHolder:
      'Search against description, metric, note and entities',
    ...
    locationMenuMonthlyUsageByServiceCategory:
      'Monthly Usage By Service Category',
    ...
    flowEndPointTopAppTrafficInfoText:
      'Please note that the time window for the MAX value is PER HOUR. The stacked height value may be larger than the max rate of the subscriber.',
    ...
    locationsAvgSubsTitle:
      'Location Average Subscriber Rate by Location and Time',
    ...
    deviceTabInfoTooltip:
      'The list of authorized devices that will be processed on the collector',
    deviceIP: 'Device IP',
    trafficMonitorOveralltooltip:
      'Real Time Traffic Monitoring of network and endpoints.',
    ...
    deviceiptooltip:
      'Packet Sampling (sflow, netflow, ipfix) exporting device address (in ipv4, ipv6 and optionally domain name)',
    ignoredownstreamtooltip:
      'Ignore (drop) flow records from the device where the flow address source matches the application subnet and destination matches the subscriber subnet.',
    ignoreupstreamtooltip:
      'Ignore (drop) flow records from the device where the flow address source matches the subscriber subnet and destination matches the application subnet.',
    ignoreinternal:
      'Ignore (drop) flow records from the device where the flow address source and destination match the subscriber subnet (which is indicative of peer to peer connection).',
    ...
    rangedPortProtocolTooltip:
      'Ranged Port/Protocol can be used for applications with range of port and protocols (5881-5882/UDP)',
    ...
    aclInfo:
      'If ACL present, user will only be granted access if connection originating from subnet list.',
    ...
    addRoleMarketing: 'Add new role for Engagement Cloud',
    ...
    marketingcs: 'Engagement Cloud Service',
    Startdate: 'Start Date',
    enddate: 'End Date',
    ...
    marketingcloudroles: 'Engagement Cloud Roles',
    ...
    trialDate: 'Trial end date',
    marketingPlatform: 'Engagement Cloud Platform',
    ...
    aboutMarketingCloud: 'About Engagement Cloud',
    ...
    rulesNotExist: (rule) => {
      return `No ${rule} Transform Alarm Rule exists <br>`;
    },
    ...
    camapign_ok: 'Okay',
    walkthrougherror:
      '(Id:256583) Sorry, the Walk-Thru you selected cannot run in the page you are currently in.',
    ...
    wifilabel:
      'Number of Wi-Fi Devices (Equal or greater than. For GigaFamily devices only)',
    wifiscorelabel:
      'Wi-Fi Score (Equal or less than. For GigaFamily devices only)',
    haswap: 'Has Mesh(SAT)? (For GigaFamily devices only)',
    hasmobile: 'Has Mobile App?',
    parentallabel:
      'Number of Basic Parental Control Profiles (Equal or greater than)',
    ...
    aboutCalixAdmin:
      'About Calix Service Cloud – Experience Management Edition',
    ...
    'Displays total number of subscribers visible in Marketing Cloud':
      'Displays total number of subscribers visible in Engagement Cloud',
    ...
    'Chart displays distribution of subscribers by usage buckets. Time period aligns to selection made in the Marketing Cloud header(30 days, last month, last two months).':
      'Chart displays distribution of subscribers by usage buckets. Time period aligns to selection made in the Engagement Cloud header(30 days, last month, last two months).',
    ...
    'Chart displays streaming subscribers by service tier. Use this information to target subscribers in low service tiers with context specific messaging based on their behavior.':
      'Chart displays streaming subscribers by service tier. Use this information to target subscribers in low servicetiers with context specific messaging based on their behavior.',

    'Marketing Cloud is tracking a number of popular streaming applications, including:':
      'Engagement Cloud is tracking a number of popular streaming applications, including:',
    Netflix: 'Netflix',
    YouTube: 'YouTube',
    Hulu: 'Hulu',
    Pandora: 'Pandora',
    ...
    RetentionModalContentFirst:
      "Provides the number of times the subscriber's downstream traffic usage reaches 90% of the max service rate.",
    RetentionModalContentSecond:
      'Provides the minutes visiting the speed test website from Ookla in the last time period selected (30 days, month, or 2 months).',
    RetentionModalContentThird:
      "Provides the minutes in the last time period that the subscriber spent visiting a competitor's website.",
    ...
    topGamingModalContentFirst:
      'This widget shows the top 10 gaming applications used by gaming subscribers with the average subscriber count and percentage.',
    ...
    wifiDeviceModalContent:
      'Click the Export Data icon (upper right) to download the category list',
    ...
    fullImportPrompt:
      'All records that are not included with the import file will be marked for deletion. A preview table will confirm all actions',
    ...
    //'Please enter a valid IP address': 'Please enter a valid subnet mask',
    ...
    wpsInfo:
      'WPS provides an easy and secure way to establish a wireless network by sharing the wireless key between the system and wireless client.',
    primary: 'Primary',
    Connect: 'Connect',
    ...
    Speed_Test_Time_Estaimation_1:
      'Speed Test can take up to 4 minutes to complete.',
    Speed_Test_Time_Estaimation_2:
      'Speed Test can take up to 2 minutes to complete.',
    Latency_Test_Time_Estaimation:
      'Latency Test can take up to 2 minutes to complete.',
    ...
    Termination_Confirmation:
      'Are you sure you want to exit, the process will be terminated!',
    ...
    Restore_Service:
      'Restore is a service interrupting operation. It automatically reboots the Service Gateway with the specified configuration. It takes approximately 5 min for the system to reboot and services to be restored.',
    ...
    Reboot_Warning:
      'Rebooting the system will interrupt the service and will take up to 5 minutes for all services (including Service Cloud) to be restored.',
    ...
    Log_Timing_Message:
      'Retrieval of Logs from the System can take 2 minutes. Upon retrieval the Logs will be available to download locally.',
    ...
    Factory_Resest_Warning:
      'Factory Reset will erase the current configuration on the Service Gateway and restore the factory default configuration after reboot',
    Reboot_timing:
      'It will take approximately 10 min for the system to reboot and services to be restored.',
    ...
    User_hint:
      'Name can only consist of letters, numbers, underscore, and whitespace',
    Number_hint: 'Please enter value between 4 and 20 characters long',
    Remote_Validation:
      'The Remote End Port should greater than the Remote Port',
    ...
    DMZ_LAN_Placing:
      'DMZ hosting enables a LAN system to use the system WAN IP address as its own. DMZ places the LAN system outside the firewall.',
    ...
    Calix_Trending_Posts:
      'Trending posts in the Calix community that match you…',
    Training_video_added: 'Training centre video added',
    Webinar_Available:
      'Webinar is now available for lorem ipsum dollar sit amen',
    ...
    Dial_Plan_Confirmation1:
      'Are you sure you want to delete the selected dial plan?',
    ...
    Device_Group_Reports_Validation:
      "Please input the system's group of reports",
    ...
    Device_Delete_Disassociate_Confirmation:
      'Do you want to disassociate this system from the subscriber or delete it?',
    ...
    New_Profile_Warning:
      'Please note that changing the ACS URL on a system will prompt it to send a 0 BOOTSTRAP, triggering any ON-DISCOVERY workflows. Be aware of this when adding this profile to any workflows.',
    ...
    Speed_Latency_Test_Configuration:
      'Speed Lantency Test Configuartion for TR-143-capable third party CPE',
    ...
    Name_required_validation1:
      'Name can only consist of alphabetical, number, underscore, whitespace',
    Name_required_validation2:
      'Name must be more than 4 and less than 20 characters long',
    ...
    time1: 'time',
    SSID_Note:
      'Updating the Wi-Fi Passphrase may take approximately 10 seconds, during which the new passphrase will not show up here!',
    Failure: 'Failure',
    ...
    'IPS Protocol Anomaly': 'IPS Protocol Anomaly',
    'IPS Port Scan Defense': 'IPS Port Scan Defense',
    ...
    'No device found by the given device(s) serial number.':
      'No system found by the given device(s) system number.',
    'Device Serial Number(s) already added.':
      'System Serial Number(s) already added.',
    'Device(s) do(es) not support TR143 or Ookla.':
      'System(s) do(es) not support TR143 or Ookla.',
    Suspend_Workflow_Before_Delete:
      'is currently in progress, please suspend the workflow before delete',
    ...
    User_info:
      'The subscriber’s system as provided in billing records has not contacted Calix Service Cloud at this time. Please check the system identifier',
    User_info2:
      'in the billing system, or check again once the system has been brought online',

    NoLink: 'NoLink',

    Issue_Description1:
      'ProtectIQ detect a virus/malware event, confirm with subscriber that their systems are not infected. Recommend a scan to be run by the subscriber.',
    Issue_Reason1: 'Virus/Malware detected in subscribers network in past day.',

    Issue_Description2:
      'This system is not getting good signal strength, this could affect the quality of experience for this system. Suggestion is for the subscriber to move the system closer or to a better line of sight to the RG/AP.',
    Issue_Reason2: 'The system RSSI is below recommended levels.',

    Issue_Description3:
      'This device has low client efficiency. If there is a subscriber experience or application related performance impact (e.g. video buffering/pausing), adding a mesh satellite node is recommended.',
    Issue_Reason3: 'Client efficiency below threshold detected.',



    Issue_Description4:
      'This system is running in older Wi-Fi mode. This may impact the Wi-Fi network performance for other systems. Suggestion is to evalute the system type and have conversation with subscriber about what the system is doing.',
    Issue_Reason4: 'Legacy system.',

    Issue_Description5:
      "The subscriber's RG has experienced a number of reboots that may affect their experience. Suggestion is to ask subscriber if they are rebooting RG, if not check logs for reboot causes and check software version.",
    Issue_Reason5:
      'Observed number of reboots in past few days has crossed threshold.',

    Issue_Description6:
      'The software upgraded failed on the system. Please check the file used and attempt again.',
    Issue_Reason6: 'Software upgrade failed.',

    Issue_Description7:
      'New features might not work for this subscriber and potential issues being seen may have been fixed in the latest software. Upgrade system to latest software.',
    Issue_Reason7: 'Software is more than 2 images behind latest release.',

    // Not part of 21.1
    Issue_Description8:
      'The subscribers experience might be affect by memory on the system, a reboot may resolve this',
    Issue_Reason8: '',
    //Not part of 21.1
    Issue_Description9:
      'The subscribers experience might be affect by high operation temperature shortening life span, ask them about placement and if it is in direct sun light, have them move it',
    Issue_Reason9: '',

    Issue_Description10:
      'The Cloud cannot talk with the Mesh(SAT), internet service could be down, the Mesh(SAT) could be powered down or placed to far from the RG. Check with the subscriber on the state of the Mesh(SAT).',
    ...
    Issue_Description11:
      'The Cloud cannot talk with RG, the internet service could be down, check for service outages in the area. Check with subscriber if they are waiting on a reboot, or if the system is powered down.',

    Issue_Reason12:
      'Observed speed test results below configured service rate by a small margin.',
    Issue_Description12:
      'If DSL service, check that DSL rates can support configured service rate, check past speed tests for trends and if the service can support configured speeds. (Between 75%-85% of configured rates)',

    Issue_Reason13:
      'Observed speed test results below configured service rate by a large margin.',
    Issue_Description13:
      'If DSL service, check that DSL rates can support configured service rate, check past speed tests for trends and if the service can support configured speeds. (Below 75% of configured rates)',

    Issue_Reason14:
      'Observed downstream throughput approached configured service limit multiple times in the past week.',
    Issue_Description14:
      'It is possible the subscriber is experiencing a degraded quality of service due to usage habits. Ask the subscriber what applications they are running. The subscriber may need to be upgraded to next tier of service.',

    Issue_Reason15: 'Observed latency above thresholds.',
    Issue_Description15:
      'The subscriber may be having quality of experience issues due to high latency above 50ms. The following types of applications may suffer with high latency video conferencing, gaming and voice. Check that the subscriber is not experiencing these issues.',

    //Not part of 21.1
    Issue_Reason16: '',
    Issue_Description16:
      'Subscriber does not have voice service up that is configured, and cannot make or receive voice calls.',

    Issue_Reason17:
      '2.4 GHz Wi-Fi channel interference is above recommended thresholds.',
    Issue_Description17:
      "The subscriber's Wi-Fi network is experiencing a lot of interference, their quality of experience maybe suffering. The system is attempting to find the best channel. If possible have client systems migrate to the 5 Ghz channel.",

    Issue_Reason18:
      '5 GHz Wi-Fi channel interference is above recommended thresholds.',
    Issue_Description18:
      "The subscriber's Wi-Fi network is experiencing a lot of interference, their quality of experience maybe suffering. The system is attempting to find the best channel. Check to see if DFS channels are available and enabled for use.",

    Issue_Reason19:
      'Detecting low channel score on 2.4 GHz band, see site scan for more information and recommendations.',
    Issue_Description19:
      'The access point is reporting a low channel score, which may mean a degraded Wi-Fi experience. Check site scan for recommendation on  which channel to change to. If the service is on the best channel, try and move as many clients to 5 Ghz band as possible.',

    Issue_Reason20:
      'Detecting low channel score on 5 Ghz band, see site scan for more information and recommendations.',
    Issue_Description20:
      'The access point is reporting a low channel score, which may mean a degraded Wi-Fi experience. Check site scan for recommendation on which channel to change to.',

    Issue_Reason21:
      'Detecting low channel score on 2.4 GHz band, the system is attempting to find a better channel.',
    Issue_Description21:
      'The access point is reporting a low channel score, which may mean a degraded Wi-Fi experience. The system has selfheal turn on and is attempting to find a better channel. Check site scan results for more details. If possible have client systems migrate to the 5 Ghz channel.',

    Issue_Reason22:
      'Detecting low channel score on 5 Ghz band, the system is attempting to find a better channel.',
    Issue_Description22:
      'The access point is reporting a low channel score, which may mean a degraded Wi-Fi experience. The system has selfheal turn on and is attempting to find a better channel. Check site scan results for more details.',

    Issue_Reason23: 'EMesh is in a degraded state.',
    Issue_Description23:
      "The Wi-Fi mesh network in the subscriber's home is not operating correctly, reboot the access point.",

    Issue_Reason24: 'Access Point placement might be too close to router.',
    Issue_Description24:
      'This access point has an extremely good connection to the router, however it is highly likely that the home coverage and speeds will be improved by moving the access point further from the router and closer to the furthest corners of the home.',

    Issue_Reason25: 'Access Point  placement is too far from the router.',
    Issue_Description25:
      'The access point has a poor connection to the router. It is highly likely that the Wi-Fi performance will be improved by moving the access point closer to the router. In certain rare occasions where Wi-Fi coverage is needed out, at very difficult to reach places (e.g. shed, garage, patio), it may be necessary to use a access point with a poor router connection to get any connection to the hard to reach places. The Wi-Fi performance is likely to be slow in this case.',

    //Not a part of 21.1
    Issue_Reason26: '',
    Issue_Description26:
      'The subscribers Wi-Fi network has a lot of traffic, clients might be suffering and having a bad exprience',
    //Not a part of 21.1
    Issue_Reason27: '',
    Issue_Description27:
      'The subscribers home has detect radar in the 5Ghz band, the following channels are off limits ',

    // Suprerceed by reason 29 and 30
    Issue_Reason28: '[2.4GHz|5GHz] Radio is disabled',
    Issue_Description28:
      'The subscriber has turned off the radio this will affect steering algorithms and may affect the quality of their experience, suggestion to turn it back on',

    Issue_Reason29: 'The 2.4 GHz band is disabled.',
    Issue_Description29:
      'This may affect steering algorithms and may affect the quality of the subscribers experience, suggestion is to turn the radio back on.',
    ...
    Issue_Reason31:
      'Observed Downstream Speed Test Results below configured service rate by a small margin.',
    Issue_Description31:
      'If copper, check that DSL rates can support configured service, check past speed tests for trends and if service can support configured speeds. (Between 75%-85% of configured rates)',

    Issue_Reason32:
      'Observed Upstream Speed Test Results below configured service rate by a small margin.',
    Issue_Description32:
      'If copper, check that DSL rates can support configured service, check past speed tests for trends and if service can support configured speeds. (Between 75%-85% of configured rates)',

    Issue_Reason33:
      'Observed Downstream Speed Test Results below configured service rate by a large margin.',
    Issue_Description33:
      'If copper, check that DSL rates can support configured service, check past speed tests for trends and if service can support configured speeds. (Below 75% of configured rates)',

    Issue_Reason34:
      'Observed  Upstream Speed Test Results below configured service rate by a large margin.',
    Issue_Description34:
      'If copper, check that DSL rates can support configured service, check past speed tests for trends and if service can support configured speeds. (Below 75% of configured rates)',
    ...
    Bandwidth_Chart_Content:
      'of the time during last 7 days, bandwidth was above 90% of the allocated',
    ...
    Name_Validation_dial_new:
      'Name may consist only of alphanumerical, underscore, dash, and whitespace characters',
    Number_Validation_Dial_New: 'Please enter a value less than or equal to 16',
    Digit_Validation_Dial_New:
      'Digit Long Timer should be greater than Digit Short Timer',
    ...
    Load_From_Device:
      'No Data Model found in the system. Please load from system.',
    ...
    sitescanSwitchInfo: (from, to, at) => {
      return `Switched from channel ${from} to ${to} @ ${at}`;
    },
    'Last Change': 'Last Change',
    'Fix Now': 'Fix Now',
    cannotInitiateSitescan: (type) => {
      return `Cannot initiate Site Scan when Radio ${type == '2.4G' ? '2.4' : type == '5G' ? '5' : '6'}GHz is Disabled`;
    },
    cannotInitiateExtenderSitescan: (type) => {
      return `Cannot initiate Site Scan when Radio ${type == '2.4G' ? '2.4' : type == '5G' ? '5' : '6'
        }GHz is Disabled`;
    },
    ...
    'Automated Note(s)': "Automated Note(s)",
    ...
    searchUsers: 'Search Users', /* CCL-43674 */
    ...
    mark_insight: 'Engagement Insights',
    ON: 'ON',
    OFF: 'OFF',
    ...
    DNS_server_IP_Addresses:
      'Please enter a comma separated list of DNS server IP addresses',
    ...
    'ExperienceIQ Provision': 'ExperienceIQ Bulk Activation',
    'ProtectIQ Provision': 'ProtectIQ Bulk Activation',
    Manufacturer: 'Manufacturer',
    ...
    TOtherReport:
      'Other report specific filter based on which type was selected',
    TOptions: 'Options',
    ...
    // 'SubscriberImpact': 'Subscriber Impact',
    ...
    no_entitlement_message:
      'You have no entitlements,Please contact the Organization Administrator.',
    ...
    'ProtectIQ Security Settings': 'ProtectIQ Security Settings',
    ProtectIQSecuritySettings: 'ProtectIQ Security Settings',
    ...
    // 'Please enter a value greater than or equal to onboarded camera value': 'Please enter a 2K Camera plan value greater than or equal to onboarded 2K Cameras',
    // 'Please enter a 4k camera value greater than or equal to onboarded 4k camera value': 'Please enter a 4K camera plan value greater than or equal to onboarded 4K Cameras',
    ...
    'Defines the IPv6 DHCP client\'s behavior after it receives a “NoAddrAvailable” from IPv6 router.': 'Defines the IPv6 DHCP client\'s behavior after it receives a “NoAddrAvailable” from IPv6 router.',
    ...
    Issue_Reason35:
      'SFP High Operating Temperature Observed.',
    Issue_Description35:
      'The subscribers experience might be affected by high operational temperature shortening life span, ask them to move the unit to cooler location. Additionally, ask the subscriber to consider powering off the unit to accelerate cooling time.',

    Issue_Reason36:
      'SFP Very High Operating Temperature Observed.',
    Issue_Description36:
      'The subscribers experience might be affected by high operational temperature shortening life span, ask them to move the unit to cooler location. Additionally, ask the subscriber to consider powering off the unit to accelerate cooling time.',
    ...
    Networks: 'Networks',
    CCO: 'CCO',
    'Marketing Cloud Service': 'Engagement Cloud Service',
    'ExperienceIQ And ProtectIQ': 'ExperienceIQ And ProtectIQ',
    'Marketing Cloud Platform': 'Engagement Cloud Platform',
    ...
    mailchimp_ins_2: 'The integration with Mailchimp allows users to send CEC audience segments directly to Mailchimp. Before you begin, you’ll need to have a Mailchimp account. If you don’t have a Mailchimp account already, you can create an account',
    ...
    mailchimp_ins_3: 'To configure your connection from CEC to Mailchimp, click the',
    ...
    hubspot_ins_4: 'If the connection is successful, you’ll be able to send your Calix Engagement Cloud segments directly to the audience you have selected in HubSpot. These will show up as tags on your existing records (or new records will appear if they are not existing contacts within HubSpot).',
    hubspot_ins_5: 'From there, you can utilize your segment in HubSpot. Once you’ve deployed a campaign in HubSpot you will start seeing channel results (sent, opened, processed, etc.) in Calix Engagement Cloud (this information is pulled back, automatically, every night).',
    ...
    removeCameraMsg: (plan?) => {
      let msg = plan ? `Do you want to proceed with removing the ${plan}K Plan Camera?` : `Do you want to proceed with removing the camera?`;
      return msg;
    },
    ...
    face_Marketing_Channel_Results: 'Facebook Engagement Channel Results',
    ...
    'Facebook Marketing Channel Configuration': 'Facebook Engagement Channel Configuration',
    ...
    facebook_ins_2: 'The integration with Facebook allows users to send Calix Engagement Cloud audience segments directly to Facebook where they can then be used for various Engagement activities. Before you begin, you’ll need to have the following:',
    ...
    facebook_ins_3: 'Once you are certain you have the above information, you’ll be able to set up the configuration from Calix Engagement Cloud to Facebook.',
    ...
    'My Apps': '"My Apps"',
    'tab': 'tab.',
    facebook_ins_4: 'Locate the Facebook app you want to connect to Calix Engagement Cloud. Click on the app and then once you’ve been redirected find and click on the',
    'Marketing API': '"Engagement API"',
    facebook_ins_5: 'section on the left sidebar. (If you don’t have the Engagement API option in the sidebar you’ll need to add it.',
    'Once you’ve expanded the Marketing API section, click on': 'Once you’ve expanded the Engagement API section, click on',
    'Tools': '"Tools."',
    ...
    facebook_ins_8: 'From there, you can utilize your engagement segment in Facebook. Once you’ve deployed a campaign in Facebook you will start seeing channel results (impressions, spend, reach, clicks, unique clicks, etc.) in Calix Engagement Cloud (this information is pulled back, automatically, every night).',
    ...
    Issue_Description_DEVICE1:
      'ProtectIQ detect a virus/malware event, confirm with subscriber that their devices are not infected. Recommend a scan to be run by the subscriber.',
    Issue_Reason_DEVICE1: 'Virus/Malware detected in subscribers network in past day.',

    Issue_Description_DEVICE2:
      'This device is not getting good signal strength, this could affect the quality of experience for this device. Suggestion is for the subscriber to move the device closer or to a better line of sight to the RG/AP.',
    ...
    Issue_Description_DEVICE4:
      'This device is running in older Wi-Fi mode. This may impact the Wi-Fi network performance for other devices. Suggestion is to evalute the device type and have conversation with subscriber about what the device is doing.',
    Issue_Reason_DEVICE4: 'Legacy device.',

    Issue_Description_DEVICE6:
      'The software upgraded failed on the device. Please check the file used and attempt again.',
    Issue_Reason_DEVICE6: 'Software upgrade failed.',

    Issue_Description_DEVICE7:
      'New features might not work for this subscriber and potential issues being seen may have been fixed in the latest software. Upgrade device to latest software.',
    Issue_Reason_DEVICE7: 'Software is more than 2 images behind latest release.',

    Issue_Description_DEVICE8:
      'The subscribers experience might be affect by memory on the device, a reboot may resolve this',
    Issue_Reason_DEVICE8: '',

    Issue_Reason_DEVICE11: 'The RG is not reachable via TR-069.',
    Issue_Description_DEVICE11:
      'The Cloud cannot talk with RG, the internet service could be down, check for service outages in the area. Check with subscriber if they are waiting on a reboot, or if the device is powered down.',

    Issue_Reason_DEVICE17:
      '2.4 GHz Wi-Fi channel interference is above recommended thresholds. The device is attempting to find a better channel.',
    Issue_Description_DEVICE17:
      "The subscriber's Wi-Fi network is experiencing a lot of interference, their quality of experience maybe suffering. The device is attempting to find the best channel. If possible have client devices migrate to the 5 Ghz channel.",

    Issue_Reason_DEVICE18:
      '5 GHz Wi-Fi channel interference is above recommended thresholds. The device is attempting to find a better channel.',
    Issue_Description_DEVICE18:
      "The subscriber's Wi-Fi network is experiencing a lot of interference, their quality of experience maybe suffering. The device is attempting to find the best channel. Check to see if DFS channels are available and enabled for use.",

    Issue_Reason_DEVICE21:
      'Detecting low channel score on 2.4 GHz band, the device is attempting to find a better channel.',
    Issue_Description_DEVICE21:
      'The access point is reporting a low channel score, which may mean a degraded Wi-Fi experience. The device has selfheal turn on and is attempting to find a better channel. Check site scan results for more details. If possible have client devices migrate to the 5 Ghz channel.',

    Issue_Reason_DEVICE22:
      'Detecting low channel score on 5 Ghz band, the device is attempting to find a better channel.',
    ...
    'Text must be under 3500 characters': 'Text must be under 3500 characters',
    Outbound: 'Outbound',
    Inbound: 'Inbound',
    new: 'New',
    ...
    radioStatusIsNotAvailable: (type) => {
      return `${type}Hz Radio Status is not available`;
    },
    ...
    addServiceError: (name: string) => {
      return 'Found an existing subscriber with same Subscriber Location ID ' + name
    },
    ...
    // 'clearedAlarmNotificationLabel': 'Send an alarm notification to recipients when Clear Threshold condition is met.',
    'clearedAlarmNotificationLabel': 'Send an <b>additional email</b> when alarms have been cleared',
    // numberAlarmTriggerNotifaication: `The <b>minimum</b> number of alarms that must be present in order to trigger this notification`,
    ...
    alarms: 'alarms',
    // 'The duration for which all criteria must be met in order to trigger this notification': 'The duration for which all criteria must be met in order to trigger this notification',
    ...
    alreadySysAssociated: (subName) => {
      return `Error! System already associated with the Subscriber ${subName ? subName : ''}.`;
    },
    ...
    scheduleFormClearThresholdText: (threshold) => {
      return `When ${threshold} uncleared alarms remain.`
    },
    // scheduleFormHalfPercentClearThresholdText: (threshold) => {
    //   return `When 50% of Quantity Threshold is cleared within 24 hours.`
    // },
    scheduleFormHalfPercentClearThresholdText: (threshold) => {
      return `Triggered when the number of not cleared alarms is below 50% of the quantity threshold within 24 hours.`
    },
    ...
    // 'Define the days that will': 'Define the days that will ',
    // not: 'not',
    // 'be included in the schedule': ' be included in the schedule',
    ...
    "Please enter a value range between 1 to 4093": "Please enter a value range between 1 to 4093",
    ...
    quntityThresholdMessage: (msg) => {
      return `<b>Note : </b>The <b>Clear Threshold</b> count should be less than or equal to <b>Quantity Threshold (${msg}).`;
    },
    clearThresholdMessage: (msg) => {
      return `The <b>minimum</b> number of alarm instances that trigger the alarm clear message notification to recipients.  It is recommended that Clear Threshold be less than or equal to the Quantity Threshold (${msg}).  If Clear Threshold is less than the Quantity Threshold, the alarm clear message notification will notify recipients of any pending alarm instances not yet cleared.`;
    },
    clearThreshold: (msg) => {
      return `<b>Note : </b>The <b> Quantity Threshold </b> count should be greater than or equal to <b> Clear Threshold (${msg}).`
    },
    exclusions_days: (day, from, to) => {
      return `Every ${day} ${from} to ${to}`
    },
    alarmRulesMsg: (name, msg) => {
      return `${name} ${msg} successfully <br> `
    },
    ...
    workflowResumeInfo: (msg) => { return `Are you sure you want to resume the workflow ${msg}` },
    workflowSuspendInfo: (msg) => { return `Are you sure you want to suspend the workflow ${msg}` },
    workflowDeleteInfo: (msg) => { return `Are you sure you want to delete the workflow ${msg}` },
    ...
    "Request_IANA_tooltip": "Defines the IPv6 DHCP client's behavior after it receives a “NoAddrAvailable” from IPv6 router.",
    "Defines the the IPv6 DHCP clients behavior after it receives a NoAddrAvailable from IPv6 router": "Defines the IPv6 DHCP client's behavior after it receives a “NoAddrAvailable” from IPv6 router.",
    ...
    ONT_soak_timeout_validate_msg: 'Please enter a value should be greater than 2880 Minutes(48 hours) and less than or equal to 172800 Minutes(120 days).',
    ...
    'constantcontact_4': 'If the connection is successful, you’ll be able to send your Calix Engagement Cloud segments directly to your Constant Contact account by deploying a Calix Engagement Cloud campaign to Constant Contact. The campaign name will show up as a tag on your existing records (or new records will appear if they are not existing contacts within Constant Contact).',
    'constantcontact_5': 'From there, you can utilize your segment in Constant Contact. Once you’ve deployed a campaign in Constant Contact you will start seeing channel results (sent, opened, processed, etc.) in Calix Engagement Cloud (this information is pulled back, automatically, every night)',
    ...
    profile_name_validation: 'Please fill out this field, 1-40 characters including letters, numbers and specific character:_(underscore)-(hyphen).(dot)',
    ...
    Issue_Description45:
      'Installed SFP module is Calix non certified and non-supported.',
    Issue_Reason46: 'Certified but non-supported SFP module in the current version.',
    Issue_Description46:
      'Installed SFP module is Calix certified but non-supported in the current version.',
    Issue_Reason47: 'The LAN is disabled.',
    Issue_Description47:
      'The LAN is disabled, and the subscriber can not access Internet service via LAN.',
    ...
    'The request will impact system operations and that the activity may take up to 60 mins': 'The request will impact system operations and that activity may take up to 60 minutes',
    'The request will impact system operations and that the activity may take up to 2 hours': 'The request will impact system operations and that activity may take up to 2 hours',
    ...
    Speed_Test_ran_sentence: 'Speed Test ran over',//only for sentence in service tab
    ...
    'Plan(s)': 'Plan(s)',
    'CMS-DB': 'CMS-DB',
    'Modification of CMS user credentials will cause a re-connect of the EXA systems for the CMS. This reconnection and resynchronization will impact systems operations and may take up to 60 mins': 'Modification of CMS user credentials will cause a re-connect of the EXA systems for the CMS. This reconnection and resynchronization will impact systems operations and may take up to 60 minutes.',
    ...
    THERMAL_HIGH_Description: (celsius) => {
      return `The subscribers experience might be affected by high operational temperature ${celsius ? `(> ${celsius}°C) ` : ''}shortening life span, ask them about placement and if it is in direct sun light, have them move it.`
    },
    THERMAL_TOO_HIGH_Reason: 'Very High Operating Temperature Observed.',
    THERMAL_TOO_HIGH_Description: (celsius) => {
      return `The subscribers experience might be affect by very high operational temperature ${celsius ? `(> ${celsius}°C) ` : ''}shortening life span, ask them about placement and if it is in direct sun light, have them move it.`
    },
    SoftwareImagesWarrningMsg: function (uniqueimagename, uniqueimageoldname) {
      return ` Are you sure you want to replace this "${uniqueimagename[0]}" existing official image with current one "${uniqueimageoldname}"?`
    },
    ...
    'time_duration_description': 'The time duration over which the quantity threshold must be reached.',
    ...
    Issue_Description_mapNtr10:
      'The Cloud cannot talk with the Mesh(SAT), internet service could be down, the Mesh(SAT) could be powered down or placed too far from the RG. Check with the subscriber on the state of the Mesh(SAT).',
    Issue_Reason_mapNtr10: 'The Mesh(SAT) is not reachable.',

    Issue_Reason_mapNtr11: 'The RG is not reachable.',
    Issue_Description_mapNtr11:
      'The Cloud cannot talk with RG, the internet service could be down, check for service outages in the area. Check with subscriber if they are waiting on a reboot, or if the system is powered down.',
    ...
    peopleRestrictnNote: (pplName) => {
      return `Restrict ${pplName}'s access to specific content, applications and websites`;
    },
    ...
    factoryResetTitle: (input, product, manufacturer) => {
      return ['GS', 'GM', 'GC', '844', '854', '836'].filter(obj => input.includes(obj)).length || ['GigaSpire', 'GigaMesh', 'GigaPoint', 'GigaPro'].includes(product)
        || ['ZYXEL'].includes(manufacturer) ? 'Restore Default' : 'Factory Reset';
      //input.includes('GS') || input.includes('GC') || input.includes('844E') || input.includes('854') || input.includes('836') || input.includes('GM')
    },
    FactoryResetInfoBasedOnModel: function (input, product, manufacturer) {
      return `${this.factoryResetTitle(input, product, manufacturer)} will erase the configuration on the service Gateway and will attempt to restore the configuration from Calix Cloud. This may take up to 10 mins.`
    },
    Airtimechartitle: function (type, currentChannel, interfer) {
      return `${type}Hz ${currentChannel ? ' Channel ' + currentChannel : ''} has ${interfer}% interference`
    },
    ...
    historicalAirtimetitle: function (type, avgPercent, numOfDays) {
      return `${type} radio has averaged ${avgPercent}% ${numOfDays}`
    },
    deviceGroupWarrningMsg: function (modalname, MemberCount, workflowcount) {
      return `Are you sure you want to delete the system group <b>${modalname}</b>?
      This system group has <b>${MemberCount}</b>
      ${MemberCount == 1 ? `<b>member</b>` : '<b>members</b>'} and
      ...
      ${workflowcount == 0 ? "" : 'Deleting this group will remove the group configuration in the workflow.'}`
    },
    ...
    ' WiFi SSID_configuration_data_differs_between_2.4GHz_and_5GHz_bands_in_existing_Provisioning_Record_and_on_saving_Provisioning_Record_will_be_updated_across_all_bands.':
      'Wi-Fi SSID configuration data differs between selected bands in existing Provisioning Record. It will be updated across all bands when saving Provisioning Record.',
    ...
    factoryResetLabel: (input) => {
      return input.includes('GS') || input.includes('GC') || input.includes('844') || input.includes('854') || input.includes('836') || input.includes('GM') || input.includes('GPR') ? 'Restore Default' : 'Factory Reset';
    },
    FactoryResetModel: function (input) {
      return `${this.factoryResetLabel(input)} will erase the configuration on the service Gateway and will attempt to restore the configuration from Calix Cloud. This may take up to 10 mins.`
    },
    ...
    servifyplan: function (plan, date) {
      return `Service plan change to <b>${plan}</b> tier was requested on <b>${date}</b>.`
    },
    ...
    'Retry': 'Retry',
    'SmallBizIQ is not supported on': 'SmartBiz is not supported on',
    ...
    "planChangeServify": function (input) {
      return input.length
        ? `*Plan change to <b class="text-capitalize">${input[0] || ''}</b> tier was requested on <b>${input[1]}</b>.`
        : ''
    },
    ...
    recurr_everyweek: (triggerDays, time) => {
      return `Every ${triggerDays} at ${time}`
    },

    recurr_month: (day, time) => {
      return `Every ${day} day of the month at ${time}`
    },
    ...
    'ZIP_Code_Filter_Lists_Description': 'Upload a ZIP Code CSV file or ZIP+4 CSV file by clicking the “Browse” button below. Uploaded files may take up to 24 hours to become available as filter options.',
    ...
    range_validation: function (v1, v2) {
      return `Please enter a value within the range ${v1} to ${v2}.`
    },
    ...
    'No applicaion name imported': 'No application name imported',
    'No applicaion group name imported': 'No applicaion group name imported',
    'No subent imported': 'No subent imported',
    ...
    "The Service Provider's Friendly Name shall not exceed 32 characters.": "The Service Provider's Friendly Name shall not exceed 32 characters.",
    ...
    //40056
    "Service Definition Template": "Service Definition Template",
    "Service Profile": "Service Profile",
    'Service Profile(Voice)': 'Service Profile(Voice)',
    'Service Profile(Data)': 'Service Profile(Data)',
    'Service Profile(Video)': 'Service Profile(Video)',
    'Copy': 'Copy',
    'Global VLAN Service Attribute': 'Global VLAN Service Attribute',
    'StaticVLAN': 'Static VLAN',
    'DynamicVLAN': 'Dynamic VLAN',
    'Template': 'Template',
    'VLAN Type': 'VLAN Type',
    ...
    'System subscriber\'s Managed Services updated successfully': 'System subscriber\'s Managed Services data updated successfully',
    ...
    'Please enter the System Name': 'Please enter the System Name',
    'SmartBiz Bulk Activation': 'SmartBiz Bulk Activation',
    'Solicited': 'Solicited',
    'Mobile App': 'Mobile App',
    "Remove Community": "Remove Community",
    'Are you sure you want to remove this community?': 'Are you sure you want to remove this community?',
    'You are about to remove a community from a system or systems, which will prevent community members from connecting to Wi-FI on those system(s).': 'You are about to remove a community from a system or systems, which will prevent community members from connecting to Wi-Fi on those system(s).',
    'Managed Services Subscriptions': 'Managed Services Subscriptions',
    ...
    'The subscriber you are attempting to delete is a member of at least one active community.': 'The subscriber you are attempting to delete is a member of at least one active community.',
    'If you want the subscriber to keep all community memberships, delete the stystem only.': 'If you want the subscriber to keep all community memberships, delete the system only.',
    'If you want the subscriber to keep the communities other than the one sponsored by you, delete their': 'If you want the subscriber to keep the communities other than the one sponsored by you, delete their',
    'c-default': 'c-default',
    'community and the system.': 'community and the system.',
    ...
    'All associated system(s) will be deleted and factory reset as well.': 'All associated system(s) will be deleted and factory reset as well.',
    'This subscriber has active Servify subscription also.': 'This subscriber has active Servify subscription also.',
    ...
    'Subscribe': 'Subscribe',
    'ExperienceIQ Bulk Activation': 'ExperienceIQ Bulk Activation',
    'ProtectIQ Bulk Activation': 'ProtectIQ Bulk Activation',
    'Status Type': 'Status Type',
    'Escalation Email': 'Escalation Email',
    'ExperienceIQ Restrictions': 'ExperienceIQ Restrictions',
    'ExperienceIQRestrictions': 'ExperienceIQ Restrictions',
    "Search System Name": "Search System Name",
    SystemDeleteWarningMessage1: 'This operation will remove the system and delete all information associated with the system, including service provisioning.',
    SystemDeleteWarningMessage2: 'Before deleting the system, please make sure the system is disconnected, otherwise it will keep trying to reconnect.',
    SystemDeleteWarningMessage3: 'If the system is currently connected, a factory reset will occur and then it will reconnect',
    'Set Threshold': 'Set Threshold',
    'Delta Threshold': 'Delta Threshold',

    'OLT Rx Light Level for GPON': 'OLT Rx Light Level for GPON ',
    'OLT Rx Light Level for XGS-PON': 'OLT Rx Light Level for XGS-PON ',
    'ONT Rx Light Level for GPON': 'ONT Rx Light Level for GPON ',
    'ONT Rx Light Level for XGS-PON': 'ONT Rx Light Level for XGS-PON ',
    'Reset to default': 'Reset to default',

    'Prospect': 'Prospect',
    'subscriber-prospect-upload': 'Subscriber/Prospect File Upload',
    'Email(s)': 'Email(s)',
    'Upload a subscriber .CSV file by clicking the “Browse” button below. Uploaded files may take up to 24 hours to be processed and matched with existing records.': 'Upload a subscriber .CSV file by clicking the “Browse” button below. Uploaded files may take up to 24 hours to be processed and matched with existing records.',
    'All uploaded files should have 8 columns or fewer,and fewer than 10,000 rows.Street Address1,City,State,ZIP are required(may not be blank).': 'All uploaded files should have 8 columns and upto 10,000 rows. Street Address1, City, State, Zip are required(may not be blank).',
    'Please use the column formats shown below:': 'Please use the column formats shown below:',
    'Upload .CSV File': 'Upload .CSV File',
    'Upload File': 'Upload File',
    'File Example': 'File Example',
    'Download Template': 'Download Template',
    'successfully matched to existing records': 'successfully matched to existing records',
    'Record Match': 'Record Match',
    'Matching entries': 'Matching Entries',
    'Non-Matching entries': 'Non-Matching Entries',
    'Please upload a file with valid format (.csv)': 'Please upload a file with valid format (.csv)',

    'Service Provisioning': 'Service Provisioning',
    'Add New CommandIQ Biz Branding': 'Add New CommandWorx Branding',
    'ONT to Subscriber Assignment': 'ONT to Subscriber Assignment',
    'Assign ONTs to Subscribers via subscriber endpoint mapping': 'Assign ONTs to Subscribers via subscriber endpoint mapping',
    'ONT Default Setup': 'ONT Default Setup',
    'Add CommandIQ Biz Branding': 'Add CommandWorx Branding',
    'Update CommandIQ Biz': 'Update CommandWorx',
    'Any day within last week': 'Any day within last week',
    'Primary Logo Format': 'Primary Logo Format',
    'White Logo Format': 'White Logo Format',
    'Please upload Primary Logo image': 'Please upload Primary Logo image',
    Primary_Logo_Upload_Size_Error: 'Please upload Primary Logo image up to',
    'PON Capacity Hits': 'PON Capacity Hits',
    //health
    'Regiones': 'Regiones',
    'Interfaces': 'Interfaces',
    'US/DS Threshold Exceeded': 'US/DS Threshold Exceeded',
    'Received/Transmitted Discarded Packets': 'Received/Transmitted Discarded Packets',
    'Received/Transmitted Error Packets': 'Received/Transmitted Error Packets',
    'Search regions': 'Search regions',
    'Search locations': 'Search locations',
    'Search systems': 'Search systems',
    'Search interfaces': 'Search interfaces',
    'Search ONTs': 'Search ONTs',
    'Sent by Calix on behalf of': 'Sent by Calix on behalf of',
    'Address/Coordinate Info': 'Address/Coordinate Info',
    'Run a site scan to select device for failover device configuration': 'Run a site scan to select device for failover device configuration',
    'Hotspot Name': 'Hotspot Name',
    'Test Hotspot': 'Test Hotspot',
    'End Hotspot Test': 'End Hotspot Test',
    'Network Data Usage': 'Network Data Usage',
    'Primary Network': 'Primary Network',
    'Point of Sale Network': 'Point of Sale Network',
    'Staff Network': 'Staff Network',
    'Captive Portal': 'Captive Portal',
    'Please note that new mapping sources take up to 12 hours to take effect.': 'Please note that new mapping sources take up to 12 hours to take effect.',
    'Please select the Region': 'Please select the Region',
    'Please select the Location': 'Please select the Location',
    'If you want the subscriber to keep all community memberships, delete the system only (if there is any).': 'If you want the subscriber to keep all community memberships, delete the system only (if there is any).',
    'Common Parameters': 'Common Parameters',
    'ONT & Integrated ONT/RG Parameters': 'ONT & Integrated ONT/RG Parameters',
    'RG Parameters': 'RG Parameters',
    'Billing Portal URL': 'Billing Portal URL',
    'MFA Request Form': 'MFA Request Form',
    'To enable MFA for your organization, complete this MFA request form.': 'To enable MFA for your organization, complete this MFA request form.',
    'Service Definition Template(Data)': 'Service Definition Template(Data)',
    'Service Definition Template(Voice)': 'Service Definition Template(Voice)',
    'Service Definition Template(Video)': 'Service Definition Template(Video)',
    'The name should be appended with a number or some string eg. _copy': 'The name should be appended with a number or some string eg. _copy.',
    'Network Access': 'Network Access',
    'Join Wi-Fi Network': 'Join Wi-Fi Network',
    ...
    'Select Day(s)': 'Select Day(s)',
    'Custom Hours': 'Custom Hours',
    'Add Time': 'Add Time',
    'The Global VLAN Service Attribute must be 1 to 64 characters': 'The Global VLAN Service Attribute must be 1 to 64 characters',
    'Calix Uploaded Release Image': 'Calix Uploaded Release Image',
    'Captive Preview': 'Captive Preview',
    'Please select a day': 'Please select a day',
    'Are you sure you want to delete Custom Alarm': 'Are you sure you want to delete Custom Alarm',
    'Custom Alarm deleted successfully': 'Custom Alarm deleted successfully',
    'Managed Services data updated successfully': 'Managed Services data updated successfully',
    'Service Definition Template data created successfully': 'Service Definition Template data created successfully',
    'Service Profile data created successfully': 'Service Profile data created successfully',
    'OUI match list data created successfully': 'OUI match list data created successfully',
    'Multicast Range Profile data created successfully': 'Multicast Range Profile data created successfully',
    'Multicast VLAN profile data created successfully': 'Multicast VLAN profile data created successfully',
    'Bandwidth tier created successfully': 'Bandwidth Tier data created successfully',
    'Service Definition Template data updated successfully': 'Service Definition Template data updated successfully',
    'Service Profile data updated successfully': 'Service Profile data updated successfully',
    'OUI match list data updated successfully': 'OUI match list data updated successfully',
    'Multicast Range Profile data updated successfully': 'Multicast Range Profile data updated successfully',
    'Multicast VLAN profile data updated successfully': 'Multicast VLAN profile data updated successfully',
    'Bandwidth Tier data updated successfully': 'Bandwidth Tier data updated successfully',
    'Arlo Secure Plan Data Removed successfully': 'Arlo Secure Plan Data Removed successfully',
    'Bark Plan Data Removed successfully': 'Bark Plan Data Removed successfully',
    'Servify Plan Data Removed successfully': 'Servify Plan Data Removed successfully',
    'and': 'and',
    'more categories': 'more categories',
    Edit_CIQBiz_Verification: 'Ask the subscriber to verify some of the following information before editing CommandWorx email addresses',
    Edit_CIQEmail_Verification: 'Ask the subscriber to verify some of the following information before editing CommandIQ email addresses',
    'Select Devices': 'Select Devices',
    'Name Cannot be empty': 'Name Cannot be empty',
    'There is no mapping source. Would you like to continue?': 'There is no mapping source. Would you like to continue?',
    'Support Information': 'Support Information',
    'Please provide valid url': 'Please provide valid url',
    'About to Expire': 'About to Expire',
    'In Grace Period': 'In Grace Period',
    'Expired': 'Expired',
    'Unknown Error - Please refresh the page': 'Unknown Error - Please refresh the page',
    'WAN Failover': 'WAN Failover',

    'Account Management': 'Account Management',
    'Search Orgs': 'Search Orgs',
    'Change Org': 'Change Org',
    'Grantors List and pagination': 'Grantors List and pagination',
    'Select an Account': 'Select an Account',
    'To grant 3rd party users access to your organization': 'To grant 3rd party users access to your organization',
    'please use this link': 'please use this link',
    'Default Role': 'Default Role',
    'Unassigned': 'Unassigned',
    'SmartTown Wi-Fi': 'SmartTown Wi-Fi',
    'SmartTown Wi-Fi Hotspot': 'SmartTown Wi-Fi Hotspot',
    'Subscriber Traffic Prioritization': 'Subscriber Traffic Prioritization',
    'Onboarded Devices': 'Onboarded Devices',
    'Cloud Health Status': 'Cloud Health Status',
    'Grantors List': 'Grantors List',
    'Back to Account Management': 'Back to Account Management',
    'EXISTING': 'EXISTING',
    'CHURNED': 'CHURNED',
    'MONTH': 'MONTH',
    'ACQUIRED': 'ACQUIRED',
    ...
    'COUNT': 'COUNT',
    'MAX': 'MAX',
    'average_user_count': 'AVERAGE USER COUNT',
    'CommandIQ Biz Status': 'CommandWorx Status',
    'Reply To': 'Reply To',
    'Send To': 'Send To',
    'Escalation Details': 'Escalation Details',
    'Save as Call Outcome': 'Save as Call Outcome',
    'Send Email': 'Send Email',
    'global_application': 'Global Application',
    'local_application': 'Local Application',
    'global_application_group': 'Global Application Group',
    'local_application_group': 'Local Application Group',
    'endpoint_export_file': 'Endpoint',
    'subnet_rule': 'Subnet Rule',
    'subnet_file_export': 'Subnet',
    'device_file_export': 'Device',
    'export_file': 'Export',
    'Unavailable': 'Unavailable',
    'Available': 'Available',
    'Invalid duration value': 'Invalid duration value',
    'no file chosen': 'no file chosen',
    'Successfully Connected to Hotspot': 'Successfully Connected to Hotspot',
    'Hotspot Connection Failed': 'Hotspot Connection Failed',
    'Password must have at least eight characters': 'Password must have at least eight characters',
    'Make sure the information entered is correct and try to connect again': 'Make sure the information entered is correct and try to connect again',
    WAN_failover_setup_msg: 'Network Resilience is set up. The hotspot test will timeout in two minutes. Click “End Hotspot Test” under Device Details to end the test connection early.',
    'This System is Running Under SmartBiz.': 'This System is Running Under SmartBiz.',
    'location_file_export': 'location',
    'RG IP Addressing': 'RG IP Addressing',
    'ONT IP Addressing': 'ONT IP Addressing',
    'Operator': 'Operator',
    'wpa3-mixed': 'WPA3-Mixed',
    'Upload valid image file': 'Upload valid image file',
    'Edit CommandWorx Email(s)': 'Edit CommandWorx Email(s)',
    'Primary CommandWorx Email': 'Primary CommandWorx Email',
    CommandWorx: 'CommandWorx',
    'Add New CommandWorx Branding': 'Add New CommandWorx Branding',
    'Add CommandWorx Branding': 'Add CommandWorx Branding',
    'Update CommandWorx': 'Update CommandWorx',
    Edit_CommandWorx_Verification: 'Ask the subscriber to verify some of the following information before editing CommandWorx email addresses',
    'CommandWorx Status': 'CommandWorx Status',
    'Staff': 'Staff',
    'Point of Sale': 'Point of Sale',
    'Not Completed': 'Not Completed',
    'CommandIQ & CommandWorx Subscribers': 'CommandIQ & CommandWorx Subscribers',
    invalidFileTypeErrorMsg: function (confilesize) {
      return `Invalid File Type: too large size: "${confilesize}" MB exceeds more than 2MB limitation`
    },
    'first': 'first',
    'Customer Portal Visitors': 'Customer Portal Visitors',
    'Login Retention': 'Login Retention',
    'WPA3-SAE': 'WPA3-SAE',
    'WPA3-SAE-WPA2-Personal': 'WPA3-SAE-WPA2-Personal',
    'Subscribers with CommandIQ and CommandWorx': 'Subscribers with CommandIQ and CommandWorx',
    'Start Date/Hour is in the past:': 'Start Date/Hour is in the past:',
    'This configuration profile is currently in use by one or more workflow(s) thus cannot be deleted.': 'This configuration profile is currently in use by one or more workflow(s) thus cannot be deleted.',
    enableDisableOntMapping: 'Are you sure you want to enable/disable ONT to subscriber mapping?',
    ontMappingNote: '(Note: it will take up to 12h to take effect)',
    'Microsites': 'Microsites',
    'login_retention_description': "A customer portal visitor's login information will be stored for the period defined below, after which it will be reset and they will be required to log in again.",
    'Max Width': 'Max Width',
    'Max Height': 'Max Height',
    'Supported Formats': 'Supported Formats',
    'Remove The Image': 'Remove The Image',
    'Cover Photo Guidelines': 'Cover Photo Guidelines',
    'Email Notification': 'Email Notification',
    'New Notification': 'New Notification',
    'Search notifications': 'Search notifications',
    'Notification Type': 'Notification Type',
    'Restrict access to specific content': 'Restrict access to specific content',
    '# of PONs with Capacity Hits': '# of PONs with Capacity Hits',
    'Configure H.248 profile in “ONT & Integrated ONT/RG Parameters” section for enabling voice on ONT': 'Configure H.248 profile in “ONT & Integrated ONT/RG Parameters” section for enabling voice on ONT.',
    ...
    'DHCP_Association_Time': 'DHCP Association Time',
    'Please select at least one Unique Key in the DHCP Key Configuration': 'Please select at least one Unique Key in the DHCP Key Configuration',
    'Configure SIP profile and Dial Plan in the “ONT & Integrated ONT/RG Parameters” section for enabling voice on ONT.': 'Configure SIP profile and Dial Plan in the “ONT & Integrated ONT/RG Parameters” section for enabling voice on ONT.',
    'PON issue observed': 'PON issue observed',
    'Low ONT light levels observed': 'Low ONT light levels observed',
    'Network Services': 'Network Services',
    'Upstream BER': 'Upstream BER',
    'Downstream BER': 'Downstream BER',
    'Error Ratio': 'Error Ratio',
    'Preferred ProtectIQ Name': 'Preferred ProtectIQ Name',
    'Preferred ExperienceIQ Name': 'Preferred ExperienceIQ Name',
    connect_timeout_error: 'Connect Timeout Seconds should be between 5 to 90',
    'Upstream Usage (% Utilization)': 'Upstream Usage (% Utilization)',
    'Downstream Usage (% Utilization)': 'Downstream Usage (% Utilization)',
    'Total Usage': 'Total Usage ',
    'BIP Error Instance(s)': 'BIP Error Instance(s)',
    'Optical Power Lower Then Threshold Instance(s)': 'Optical Power Lower Then Threshold Instance(s)',
    upgrade_msg: function (value) {
      return `The quarterly Calix Cloud upgrade on ${value} coincides with the testing window. Test results may be incomplete.`;
    },
    'Highest Total Usage': 'Highest Total Usage',
    'Highest Downstream Usage': 'Highest Downstream Usage',
    'Highest Upstream Usage': 'Highest Upstream Usage',
    'Email Notifications': 'Email Notifications',
    'New Outage Notification': 'New Outage Notification',
    'Internet Outage': 'Internet Outage',
    'Get notified when alarms are triggered': 'Get notified when alarms are triggered',
    'Receive an immediate outage notification for monitored areas': 'Receive an immediate outage notification for monitored areas',
    'Start Notification': 'Start Notification',
    'Frequency Threshold': 'Frequency Threshold',
    'Frequency of email notifications during the outage': 'Frequency of email notifications during the outage',
    'Please enter a value between 1 and 10000': 'Please enter a value between 1 and 10000',
    'Please enter a number up to 36 characters': 'Please enter a number up to 36 characters',
    'Access Control List': 'Access Control List',
    'ACL Entry for Remote Access': 'ACL Entry for Remote Access',
    'Configure ACL Entry for Remote Access': 'Configure ACL Entry for Remote Access',
    'ACL Entry for VoIP': 'ACL Entry for VoIP',
    'Configure ACL Entry for VoIP': 'Configure ACL Entry for VoIP',
    'ACL Rule': 'ACL Rule',
    'New Rule': 'New Rule',
    'Enable ACL': 'Enable ACL',
    'IP Address already exists': 'IP Address already exists',
    'Enter IP Address': 'Enter IP Address',
    'Character length should not exceed 64 characters': 'Character length should not exceed 64 characters',
    'Character length should not exceed 90 characters': 'Character length should not exceed 90 characters',
    'Character length should not exceed 512 characters': 'Character length should not exceed 512 characters',
    'Character length should not exceed 128 characters': 'Character length should not exceed 128 characters',
    capitive_portal_color_validate: "Color code should start with '#' followed by letters from a-f, A-F and/or digits from 0-9. And length of code should be within 3 to 6 excluding '#'",
    'Are you sure you want to delete image?': 'Are you sure you want to delete image?',
    'Initial IPFIX state': 'Initial IPFIX state',
    'Service Status': 'Service Status',
    'Router WAN Status': 'Router WAN Status',
    'Router WAN Configuration': 'Router WAN Configuration',
    'ONT Data Service': 'ONT Data Service',
    'Provisioned Upstream (Mbps)': 'Provisioned Upstream (Mbps)',
    'Provisioned Downstream (Mbps)': 'Provisioned Downstream (Mbps)',
    'Category List': 'Category List',
    'Applications List': 'Applications List',
    'Supported': 'Supported',
    'On Boot': 'On Boot',
    'Triggered_CPE_Boot': 'Triggered when the CPE boots up',
    'Billing Pipeline Status': 'Billing Pipeline Status',
    'Systems Count Check': 'Systems Count Check',
    'Unique “Location ID” Count Check': 'Unique “Location ID” Count Check',
    'Matched Endpoint Count Check': 'Matched Endpoint Count Check',
    'Unique Subscriber Count Check': 'Unique Subscriber Count Check',
    'Total Record Count Check': 'Total Record Count Check',
    'Last Billing Data Sanity Check': 'Last Billing Data Sanity Check',
    'Billing Data': 'Billing Data',
    'Subscribers Deleted': 'Subscribers Deleted',
    'Subscribers Updated': 'Subscribers Updated',
    'Subscribers Added': 'Subscribers Added',
    'Last Successful Processing': 'Last Successful Processing',
    'Subscriber Sync': 'Subscriber Sync',
    'Last Billing File Generated': 'Last Billing File Generated',
    'Multicast VLAN Profile': 'RG Multicast VLAN Profile',
    'Multicast Range Profile': 'RG Multicast Range Profile',
    'Multicast Range': 'RG Multicast Range',
    "Multicast VLAN": "RG Multicast VLAN",
    'Please enter the Diret Connect Number less than or equal to 32 charecters': 'Please enter the Diret Connect Number less than or equal to 32 charecters',
    'Active Devices GeoMap': 'Active Devices GeoMap',
    'Show Only ONT Internet Outage': 'Show Only ONT Internet Outage',
    'Internet Outage Cause': 'Internet Outage Cause',
    'Import DPI': 'Import DPI',
    'Override_DPI': 'Override DPI',
    'App_ID': 'App ID',
    'Protocol_ID': 'Protocol ID',
    'Please upload XML file': 'Please upload XML file',
    'Create Application Definition': 'Create Application Definition',
    'Create Group': 'Create Group',
    'importExportDpi': 'Import/Export DPI',
    'importExportDpiNote': 'Specify whether you want to import a DPI file or export the current file as a .CSV',
    'Create Definition': 'Create Definition',
    'All Application Group': 'All Application Group',
    'Active Systems GeoMap': 'Active Systems GeoMap',
    'Active GeoMap': 'Active GeoMap',
    'Please create a Call Outcome record to visit selected page': 'Please create a Call Outcome record to visit selected page',
    'SmartBiz is not supported on EXOS versions older than R23.1.0. Please, upgrade your system(s) to R23.1.0 or later versions.': 'SmartBiz is not supported on EXOS versions older than R23.1.0. Please, upgrade your system(s) to R23.1.0 or later versions.',
    'RG Multicast Range Profile data created successfully': 'RG Multicast Range Profile data created successfully',
    'RG Multicast VLAN Profile data created successfully': 'RG Multicast VLAN Profile data created successfully',
    'RG Multicast Range Profile data updated successfully': 'RG Multicast Range Profile data updated successfully',
    'RG Multicast VLAN Profile data updated successfully': 'RG Multicast VLAN Profile data updated successfully',
    'Longitude & Latitude': 'Longitude & Latitude',
    'Get Latitude/Longitude Coordinates': 'Get Latitude/Longitude Coordinates',
    ...
    'WPA3MIXED': 'WPA3MIXED',
    'WPA3': 'WPA3',
    'Hover on an issue to see more details': 'Hover on an issue to see more details.',
    'Network Resilience': 'Network Resilience',
    'Connected via Network Resilience': 'Connected via Network Resilience',
    'Online and Offline Devices': 'Online and Offline Devices',
    'Any Band': 'Any Band',
    'ignore_ipfix_app_id': 'Ignore IPFIX App ID',
    'import_ipfix_app_id': 'Import IPFIX App ID',
    'The secondary WAN is up': 'The secondary WAN is up',
    'The secondary WAN is down': 'The secondary WAN is down',
    'The Network Resilience interface is up and running': 'The Network Resilience interface is up and running',
    'The Network Resilience interface is configured but it is not running. Ensure that the mobile device or hotspot associated is powered on and in range': 'The Network Resilience interface is configured but it is not running. Ensure that the mobile device or hotspot associated is powered on and in range',
    'View All Subscribers': 'View All Subscribers',
    'This subscriber is experiencing an internet outage': 'This subscriber is experiencing an internet outage',
    'Manage Trigger Campaigns': 'Manage Trigger Campaigns',
    'Manage Campaign': 'Manage Campaign',
    'Pause Campaign': 'Pause Campaign',
    'Pause_Campaign_Msg': 'When paused, this campaign will not send any messages until it is unpaused. It may take up to 24 hours for a pause to take effect.',
    'Create Campaign': 'Create Campaign',
    'Unpause Campaign': 'Unpause Campaign',
    'Unpause_Campaign_Msg': 'This campaign will resume sending messages once it has been unpaused. It may take up to 24 hours for an unpause to take effect.',
    'Do Not Resend For (Days)': 'Do Not Resend For (Days)',
    'Instances per 30 Days to Trigger': 'Instances per 30 Days to Trigger',
    'Campaign_Audience_Size': 'Campaign Audience Size',
    'Daily_Campaign_Audience': 'Daily Campaign Audience',
    prior_post: 'Prior/Paused/Post Campaign Period',
    Audience_last: 'Audience (Last Sent)',
    note_hint: 'Do not Deploy unless you have already created the campaign in Mailchimp',
    audiance_mailchimp_note: 'Audience data will be sent daily to Mailchimp',
    'ONT upstream SDBER rate exceeded': 'ONT upstream SDBER rate exceeded',
    'ONT downstream SDBER rate exceeded': 'ONT downstream SDBER rate exceeded',
    'low power levels measured at the ONT': 'Low power levels measured at the ONT',
    'Sync and Configuration Information': 'Sync and Configuration Information',
    'System Controller': 'System Controller',
    'Cards': 'Cards',
    'Card': 'Card',
    'Card Type': 'Card Type',
    'Provisioned Type': 'Provisioned Type',
    'Operational State': 'Operational State',
    'Card Location': 'Card Location',
    'Up Time': 'Up Time',
    'CPU Usage': 'CPU Usage',
    'RAM Usage': 'RAM Usage',
    'Intake Temperature': 'Intake Temperature',
    'Fan Speed': 'Fan Speed',
    ...
    'Upstream BIP Errors': 'Upstream BIP Errors',
    'Downstream BIP Errors': 'Downstream BIP Errors',
    'Upstream Uncorrected FEC Codewords': 'Upstream Uncorrected FEC Codewords',
    'Downstream Uncorrected FEC Codewords': 'Downstream Uncorrected FEC Codewords',
    'Search ONTs': 'Search ONTs',
    //TAB Title
    'Search Results': 'Search Results',
    'Service Provider Acquisition Data Insights': 'Service Provider Acquisition Data Insights',
    'Advanced-TS': 'Advanced-TS',
    'Prospect-TS': 'Prospect-TS',
    'User Detail': 'User Detail',
    'Applications Groups': 'Applications Groups',
    'End point': 'End point',
    'Add Block Template': 'Add Block Template',
    'Update Block Template': 'Update Block Template',
    'SmartTown Wifi': 'SmartTown Wifi',
    'Subscriber Prospect File Upload': 'Subscriber Prospect File Upload',
    'Operation Cloud': 'Operation Cloud',
    'Block Template View': 'Block Template View',
    'Search keyword length should not be less than 3!': 'Search keyword length should not be less than 3!',
    'Please enter a value less than or equal to 512': 'Please enter a value less than or equal to 512',
    'Audience Distribution': 'Audience Distribution',
    'Cumulative Audience Members Included in Selected Channels': 'Cumulative Audience Members Included in Selected Channels',
    resendrequired: 'Do Not Resend For (Days) Required',
    Triggerrequired: 'Instances per 30 Days to Trigger Required',
    'Not Enabled': 'Not Enabled',
    'Orphan Systems': 'Orphan Systems',
    'Please enter the Passphrase': 'Please enter the Passphrase',
    'ONT has low power level': 'ONT has low power level, ONT or it’s component may need replacement soon.',
    'Downstream Signal Degrade Bit Error Rate': 'Downstream Signal Degrade Bit Error Rate is exceeding the threshold. Ask the subscriber to check if the cable is tightly connected to ONT. If the issue does not resolve then a technician visit may be necessary to troubleshoot and fix the issue.',
    'Upstream Signal Degrade Bit Error Rate': 'Upstream Signal Degrade Bit Error Rate is exceeding the threshold. Ask the subscriber to check if the cable is tightly connected to ONT. If the issue does not resolve then a technician visit may be necessary to troubleshoot and fix the issue.',
    'Edit System Group': 'Edit System Group',
    'Add Configuration Files': 'Add Configuration Files',
    'Impacted ONTs Count': 'Impacted ONTs Count',
    Issue_Reason48: 'RG is reachable however the Network Resilience interface is up',
    Issue_Description48: 'The Cloud can talk with RG but internet service could be down, check for service outages in the area. Check with the subscriber if they are waiting on a reboot or some other issue.  The Network Resilience interface is up and running',
    Issue_Reason49: 'RG is not reachable via TR-069 however the Network Resilience interface is up',
    Issue_Description49: 'The Cloud cannot talk with RG via TR-069, and the internet service could be down, check for service outages in the area. Check with the subscriber if they are waiting on a reboot or some other issue.  The Network Resilience interface is up and running',
    Issue_Reason50: 'RG is not reachable. The Network Resilience interface is down',
    Issue_Description50: 'The Cloud cannot talk with RG, and the internet service could be down, check for service outages in the area. Check with the subscriber if they are waiting on a reboot or some other issue. The Network Resilience interface is configured but it is not running. Ensure that the mobile device or hotspot associated is powered on and in range',
    'Disassociate, Delete System and Delete CommandWorx Email(s)': 'Disassociate, Delete System and Delete CommandWorx Email(s)',
    'Disassociate, Delete System and Delete CommandIQ Email(s)': 'Disassociate, Delete System and Delete CommandIQ Email(s)',
    'Are services configured through a different system or via E2E service provisioning?': 'Are services configured through a different system or via E2E service provisioning?',
    'Delete Campaign': 'Delete Campaign',
    Delete_Campaign_Confirmation: 'Are you sure you want to delete this campaign? This cannot be undone.',
    'Realtime': 'Realtime',
    'Endpoints': 'Endpoints',
    'Federated': 'Federated',
    'Mesh': 'Mesh',
    "This alert is already trusted and requires no further action.": "This alert is already trusted and requires no further action.",
    'The VoIP Switch IP addresses below will be allowed to manage the GigaSpire VoIP Gateway': 'The VoIP Switch IP addresses below will be allowed to manage the GigaSpire VoIP Gateway',
    'The Access control IP addresses below will be allowed to remotely access the GigaSpire EWI': 'The Access control IP addresses below will be allowed to remotely access the GigaSpire EWI',
    'Average_revenue': 'Average Revenue Per Campaign Member',
    'total_audience': 'Total Revenue of Campaign Audience',
    'revenue_household': 'Revenue Per Household',
    'postcampaign': 'Post Campaign Period',
    'campaignaudi': 'Campaign Audience',
    'Audience Members Included in Selected Channels': 'Audience Members Included in Selected Channels',
    'SSID Name without special characters': 'Please enter the name without special characters,head or trailing spaces are not allowed',
    'SSID Password without special characters': 'Please enter the passphrase without special characters,head or trailing spaces are not allowed',
    'Disconnected, Network Resilience not up': 'Disconnected, Network Resilience not up',
    'OLT System': 'OLT System',
    'Select a region, location, and OLT system to be included in the report': 'Select a region, location, and OLT system to be included in the report',
    'Internet Outage Notification Schedule successfully paused': 'Internet Outage Notification Schedule successfully paused',
    'Internet Outage Notification Schedule successfully deployed': 'Internet Outage Notification Schedule successfully deployed',
    'Optical Outliers Notification Schedule successfully paused': 'Optical Outliers Notification Schedule successfully paused',
    'Optical Outliers Notification Schedule successfully deployed': 'Optical Outliers Notification Schedule successfully deployed',
    'Internet Outage Notification Schedule successfully deleted': 'Internet Outage Notification Schedule successfully deleted',
    'Optical Outliers Notification Schedule successfully deleted': 'Optical Outliers Notification Schedule successfully deleted',
    'Are you sure you want to delete Internet Outage Notification': 'Are you sure you want to delete Internet Outage Notification',
    'Are you sure you want to delete Optical Outliers Notification': 'Are you sure you want to delete Optical Outliers Notification',
    'Optical Outliers': 'Optical Outliers',
    'Receive a weekly report on selected OLT systems': 'Receive a weekly report on selected OLT systems',
    'CallOutcomeLogoutConfirmation': 'Call Outcome has not been saved, are you sure to exit or close the tab?',
    "piq_eiq_similar_name_err": "Preferred ProtectIQ Name shouldn't be same as the Preferred ExperienceIQ Name",
    'Enable IPFIX on EXA OLTs serviced by this CMS': 'Enable IPFIX on EXA OLTs serviced by this CMS',
    'You don’t have permission to edit CommandIQ email addresses': 'You don’t have permission to edit CommandIQ email addresses',
    'The selected date and time is already Added': 'The selected date and time is already Added.',
    'Real Time Alarms View': 'Real Time Alarms View',
    'Windows Installation Instructions': 'Windows Installation Instructions',
    'install_Passpoint_profile_Windows': 'To install a Passpoint profile on Windows 10 or 11, make sure to open the Passpoint installation site using Edge or Chrome.',
    'microsite_preview_install_profile': 'Next, click the <b>Install Profile</b> button on the installation site.',
    'Windows_Settings_Click_Open': 'The browser may ask for permission to open Windows Settings. Click <b>Open</b>',
    'After_the_download_completes': 'After the download completes, a <b>Profile downloaded </b>message will appear.',
    'Wi-Fi_network_Click_add': 'A settings box will also appear asking if you want to add the Wi-Fi network. Click <b>Add.</b>',
    "Your_profile_should_now_be_installed": "That's it! Your profile should now be installed.",
    'Your_device_will_now_automatically_connect': 'Your device will now automatically connect to supported Passpoint networks.',
    'Get_your_passpoint_profile_installed': 'Watch this short one minute video to learn how to get your passpoint profile installed.',
    'Click the button below to install your profile.': 'Click the button below to install your profile.',
    "Download_Install_Your_Passpoint": "Download and Install Your Passpoint® Profile",
    'I accept the Terms and Conditions': 'I accept the Terms and Conditions',
    'I accept the': 'I accept the',
    'Terms and Conditions': 'Terms and Conditions',
    'Install Profile': 'Install Profile',
    Browser_msg: function (value, data) {
      return `It looks like you are using a ${value} device with ${data}`;
    },
    ONT_Ports: 'ONT Ports',
    ...
    'In some test mode. No operational packets can be passed': 'In some test mode. No operational packets can be passed',
    ...
    'Upstream-Downstream-PON Threshold Value': 'Upstream or downstream PON Capacity Utilization',
    'Upstream or downstream Ethernet/AE Capacity Utilization': 'Upstream or downstream Ethernet/AE Capacity Utilization',
    'Optical Outliers Notifications': 'Optical Outliers Notifications',
    'Internet Outage Notifications': 'Internet Outage Notifications',
    'CommandWorx Email': 'CommandWorx Email',
    'CommandIQ Email': 'CommandIQ Email',
    'GigaCenter/GigaHub/GigaPoint maximum # of multicast streams threshold': 'For GigaCenter/GigaHub/GigaPoint ONT, the maximum # of multicast streams threshold is 0~256.\nFor EXOS ONT,  the maximum # of multicast streams threshold is 0~128.\nFor GigaCenter/GigaHub standalone RG, the maximum # of multicast streams threshold is 0~512.\nFor EXOS standalone RG,  the maximum # of multicast streams threshold is 0~128.',
    'Restriction Settings': 'Restriction Settings',
    'ONT with BIP Error': 'ONT with BIP Error',
    'ONT with Low Optical Power': 'ONT with Low Optical Power',
    'I agree to the': 'I agree to the',
    'No client activity for Efficiency score': 'No client activity for Efficiency score',
    'Calix Partner Escalation from': 'Calix Partner Escalation from',
    checkRestoreorReset: "<b>All associated system(s) will be deleted and restore default as well. Configured services over ONT will be deleted from OLT.<b>",
    checkRestoreorResetInSystem: "<b>If the system is currently connected, it will be restore default and then reconnect.<b>",
    checkRestoreorResetInSystemFound: "<b>If the system is currently connected, a restore default will occur and then it will reconnect.<b>",
    'All associated system(s) will be deleted and restore default as well.': 'All associated system(s) will be deleted and restore default as well.',
    'Successfully Provisioned': 'Successfully Provisioned',
    'Small Business Gateway': 'Small Business Gateway',
    'Enable Legacy(NetOps) View': 'Enable Legacy(NetOps) View',
    'Disable Legacy(NetOps) View': 'Disable Legacy(NetOps) View',
    'All Communities': 'All Communities',
    'Applied to both PON-integrated RGs and Ethernet RGs': 'Applied to both PON-integrated RGs and Ethernet RGs',
    'Sorry, you can set up to five network access hour time slots each day': 'Sorry, you can set up to five network access hour time slots each day.',
    CmcSubscriber_Status_Msg: 'Specify the number of days a subscriber labeled as suspended in the billing record is changed to churned.',
    'Suspended Status Duration': 'Suspended Status Duration',
    'Marketing Cloud Settings': 'Engagement Cloud Settings',
    'Please enter a value within the range 1 to 99': 'Please enter a value within the range 1 to 99',
    'Do not convert suspended subscribers into churned subscribers': 'Do not convert suspended subscribers into churned subscribers',
    'Change Suspended Status Duration': 'Change Suspended Status Duration',
    'suspend_status_duration_msg': 'Changing a suspended status duration can impact the count of active and churned subscribers, values shown in lenses and segment sizes.',
    'Change Duration': 'Change Duration',
    'Do Not Convert Suspended Subscribers': 'Do Not Convert Suspended Subscribers',
    'Suspended subscribers will remain in suspended status until changed through updated data.': 'Suspended subscribers will remain in suspended status until changed through updated data.',
    'Please select an organization(s)': 'Please select an organization(s)',
    'Reset Triggered Campaign': 'Reset Triggered Campaign',
    TriggeredCampaignsMsg: 'Triggered campaigns can not be deleted, but can be reset. Resetting this campaign will revert it to its default state.',
    'Reset Campaign': 'Reset Campaign',
    'System Onboarding': 'System Onboarding',
    'CMS EXA Call Home': 'CMS/EXA Call Home',
    'AXOS Call Home': 'AXOS Call Home',
    'Alarm & Health Notifications': 'Alarm & Health Notifications',
    'Alarm Settings': 'Alarm Settings',
    'Monitoring Thresholds': 'Monitoring Thresholds',
    'Subscriber List': 'Subscribers List',
    'Services Profiles': 'Services Profiles',
    'Orchestration': 'Orchestration',
    'L2 VPN': 'L2 VPN',
    'ONT configurations': 'ONT Configurations',
    'RG Dial Plans': 'RG Dial Plans',
    'ASM Application': 'ASM Application',
    'Flow Data': 'Flow Data',
    'Changes saved successfully': 'Changes saved successfully',
    'Data Source': 'Data Source',
    'Use ASM applications data': 'Use ASM applications data',
    'Use application data defined by my organization': 'Use application data defined by my organization',
    'Uses information detected in IPFIX data provided from AXOS systems': 'Uses information detected in IPFIX data provided from AXOS systems',
    'Uses definitions from the Applications > Definitions tab': 'Uses definitions from the Applications > Definitions tab',
    'Call Outcome Timer': 'Call Outcome Timer',
    'Call Outcome Timer Details': 'Set a timer for viewing subscriber records before call outcome reports are required. An audit log entry will not be made if  subscriber records are closed before the timer expires.',
    'Save Timer': 'Save Timer',
    'Call Outcome Status': 'Call Outcome Status',
    Acquisitions: 'Acquisition',
    'callOutcomeLogoutConfirm': 'Call Outcome has not been saved, are you sure you want to exit or close the tab?',
    'Audit': 'Audit',
    'Lookup': 'Lookup',
    invalid_domain_name: 'Invalid Domain Name',
    applications_audit: 'Applications Audit',
    accept: 'Accept',
    'One or more applications cannot be audited due to missing domain name.': 'One or more applications cannot be audited due to missing domain name.',
    'The following configuration changes have been found.': 'The following configuration changes have been found.',
    'Please review and select the changes you would like to accept.': 'Please review and select the changes you would like to accept.',
    'No Domain Name available': 'No Domain Name available',
    'Not audited due to missing domain name': 'Not audited due to missing domain name',
    'DSL': 'DSL',
    'Configured DSL Ports': 'Configured DSL Ports',
    'DSL Ports in Showtime Status': 'DSL Ports in Showtime Status',
    'Not At Target SNR By Region': 'Not At Target SNR By Region',
    'Not At Target SNR By Location': 'Not At Target SNR By Location',
    'Not At Target SNR By System': 'Not At Target SNR By System',
    'Not At Target SNR By Interface': 'Not At Target SNR By Interface',
    'Not At Attainable Rate By Region': 'Not At Attainable Rate By Region',
    'Not At Attainable Rate By Location': 'Not At Attainable Rate By Location',
    'Not At Attainable Rate By System': 'Not At Attainable Rate By System',
    'Not At Attainable Rate By Interface': 'Not At Attainable Rate By Interface',
    'Threshold Exceeded': 'Threshold Exceeded',
    'Not at Attainable Rate': 'Not at Attainable Rate',
    'Not At Target SNR': 'Not At Target SNR',
    'DSL Port Count': 'DSL Port Count',
    'Attainable Rate': 'Attainable Rate',
    'DSL Port Outside Range': 'DSL Port Outside Range',
    'usCurRate': 'Upstream Current Rate',
    'dsCurRate': 'Downstream Current Rate',
    'usAttRate': 'Upstream Attainable Rate',
    'dsAttRate': 'Downstream Attainable Rate',
    'usSnrMargin': 'Upstream SNR Margin',
    'dsSnrMargin': 'Downstream SNR Margin',
    'usTargetSnr': 'Upstream Target SNR',
    'dsTargetSnr': 'Downstream Target SNR',
    'retrainCnt': 'Retrain Count',
    'rxDisRate': 'Receive Discards To Packets Ratio',
    'rxErrRate': 'Receive Errors To Packets Ratio',
    'Provisioned Subscribers': 'Provisioned Subscribers',
    'Network Access Hours': 'Network Access Hours',
    'No Limit': 'No Limit',
    'Add Network Access Hours': 'Add Network Access Hours',
    'Save Access Hours': 'Save Access Hours',
    'Save & Add Another': 'Save & Add Another',
    'Network Disabled': 'Network Disabled',
    'Privacy': 'Privacy',
    'Show sensitive information': 'Show sensitive information',
    'Copy Primary Wi-Fi SSIDs to replacement system (844-series RGs only)': 'Copy Primary Wi-Fi SSIDs to replacement system (844-series RGs only)',
    'Identifiable information msg': 'This information is personally identifiable information, and all access will be logged',
    'Access confirm msg': 'I confirm I am accessing this information to address service issues and understand my access will be logged.',
    'AXOS Systems': 'AXOS Systems',
    'CMS/EXA Systems': 'CMS/EXA Systems',
    'Region Settings': 'Region Settings',
    'Add Call Home': 'Add Call Home',
    'Unsynchronized AXOS Systems': 'Unsynchronized AXOS Systems',
    'Unsynchronized CMS/EXA Systems': 'Unsynchronized CMS/EXA Systems',
    'Early Warning PON Capacity': 'Early Warning PON Capacity',
    'Receive a weekly report on siginificant PON capacity changes': 'Receive a weekly report on siginificant PON capacity changes',
    'Early Warning Ethernet Capacity': 'Early Warning Ethernet Capacity',
    'Receive a weekly report on siginificant Ethernet capacity changes': 'Receive a weekly report on siginificant Ethernet capacity changes',
    'Early Warning PON Loss': 'Early Warning PON Loss',
    'Receive a weekly report on siginificant PON Loss': 'Receive a weekly report on siginificant PON Loss',
    'Hover over an issue and click available options to see more details': 'Hover over an issue and click available options to see more details',
    'Select an interface to view not at attainable rate on that interface': 'Select an interface to view not at attainable rate on that interface',
    'Select an interface to view not at target SNR on that interface': 'Select an interface to view not at target SNR on that interface',
    'Domain name lookup successful': 'Domain name lookup successful',
    'Domain-name-lookup-successful-info': 'The fields below have been populated with information returned by the Domain Lookup.',
    'added': 'added',
    'Unable to Apply Wi-Fi Configurations': 'Unable to Apply Wi-Fi Configurations',
    'Wi-Fi Configurations msg': 'Existing Wi-Fi configurations cannot be applied to the replacement system if the current system is offline. Do you wish to continue?',
    'At least one recipient must be entered': 'At least one recipient must be entered',
    'View 10 Subscribers': 'View 10 Subscribers',
    'View 25 Subscribers': 'View 25 Subscribers',
    'View 50 Subscribers': 'View 50 Subscribers',
    'Scheduled Campaigns': 'Scheduled Campaigns',
    'Triggered Campaigns': 'Triggered Campaigns',
    'New Scheduled Campaign': 'New Scheduled Campaign',
    'Scheduled Campaign': 'Scheduled Campaign',
    'Triggered Campaign': 'Triggered Campaign',
    'New Triggered Campaign': 'New Triggered Campaign',
    'Last Deployment': 'Last Deployment',
    'Total Channel Audience': 'Total Channel Audience',
    'Audience History': 'Audience History',
    'Trigger is Required': 'Trigger is Required',
    'Subscribers who qualify for multiple': 'Subscribers who qualify for multiple',
    'campaigns will only be included in one campaign.': 'campaigns will only be included in one campaign.',
    'Clear segment': 'Clear segment',
    Audience_Members: 'Audience Members',
    'Instances Required to Trigger': 'Instances Required to Trigger',
    'Do Not Resend For': 'Do Not Resend For',
    'in 30 days': 'in 30 days',
    'speed tests in 30 days': 'speed tests in 30 days',
    'Instances per 30 to 999 Days to Trigger Required': 'Instances per 30 to 999 Days to Trigger Required',
    'Do Not Resend For 45 to 365 Days Required': 'Do Not Resend For 45 to 365 Days Required',
    'This criteria will apply to all': 'This criteria will apply to all',
    'campaigns': 'campaigns',
    'Estimated Next Audience': 'Estimated Next Audience',
    'At time of deployment': 'At time of deployment',
    'Impacted Campaigns': 'Impacted Campaigns',
    'Mailchimp Event Name': 'Mailchimp Event Name',
    'Mailchimp Event Name is Required': 'Mailchimp Event Name is Required',
    'will be deployed to Mailchimp when you click “Deploy Campaign.”': 'will be deployed to Mailchimp when you click “Deploy Campaign.”',
    'minutes in 30 days': 'minutes in 30 days',
    'Select Trigger': 'Select Trigger',
    'Competitor Site Minutes (Mobile Notification Only)': 'Competitor Site Minutes (Mobile Notification Only)',
    'Speed Test Minutes  (Mobile Notification Only)': 'Speed Test Minutes  (Mobile Notification Only)',
    'Page Content': 'Page Content',
    "RG is offline and WiFi details may not be swapped. Would you like to Continue?": "RG is offline and WiFi details may not be swapped. Would you like to Continue?",
    'This subscriber is experiencing a service disruption': 'This subscriber is experiencing a service disruption',
    'Name cannot be changed': 'Name cannot be changed',
    'BSP Subscriber': 'BSP Subscriber',
    'Community Access': 'Community Access',
    'Edit access': 'Edit access',
    'reduce the number of records': 'The CSV file cannot contain more than 500 user records. Please reduce the number of records to fit the limit.',
    'uploading a CSV file with their information': 'Grant users access to your communities by uploading a CSV file with their information.',
    'Only .csv format is supported.': 'Only .csv format is supported.',
    'Please use the format exactly as shown below:': 'Please use the format exactly as shown below:',
    'Edit Users': 'Edit Users',
    'Are you sure you want to remove access to': 'Are you sure you want to remove access to',
    'for this user?': 'for this user?',
    'Remove access': 'Remove access',
    'This user has access to the following communities': 'This user has access to the following communities',
    'This will disable their access from all communities': 'This will disable their access from all communities',
    'Confirm Users': 'Confirm Users',
    'Errors found in User Records CSV': 'Errors found in User Records CSV',
    'Please correct the errors and re-upload the CSV file': 'Please correct the errors and re-upload the CSV file, or continue with this version. Only user records without errors will be added.',
    'errors': 'errors',
    'Adding users to the communities specified in the CSV': 'Adding users to the communities specified in the CSV',
    'complete': 'complete',
    'Users successfully added to the communities specified in the CSV': 'Users successfully added to the communities specified in the CSV',
    'The process for adding users to the communities has been stopped': 'The process for adding users to the communities has been stopped',
    'Access will be granted and a welcome email will be sent to the following users': 'Access will be granted and a welcome email will be sent to the following users',
    'errors found': 'errors found',
    'Correct the following errors and re-upload the CSV file': 'Correct the following errors and re-upload the CSV file',
    'Stop adding users': 'Stop adding users',
    'Only users that have successfully been added will be granted access': 'Only users that have successfully been added will be granted access',
    'Yes, stop adding users': 'Yes, stop adding users',
    'Community Users': 'Community Users',
    'community_removed_successfully': (communityName) => `Access to <strong>${communityName}</strong> removed successfully.`,
    'Add Community': 'Add Community',
    'Bsp_T&C_URL': 'Terms & Conditions URL',
    'Delete_Communities': 'Delete Community',
    'Edit_Communities': 'Edit Community',
    'All_communities': 'All communities',
    'community_Delete_Mes_for_community': "Deleting this community will disable subscriber's access to this community, as well as the system's support for this community.",
    'Adding Users': 'Adding Users',
    'Must match Mailchimp campaign trigger ‘Event Name’ exactly': 'Must match Mailchimp campaign trigger ‘Event Name’ exactly.',
    'AXOS Migration': 'AXOS Migration',
    'devices_status': 'Devices Status',
    'devices_name_placeholder': 'Devices Name Placeholder',
    'device_name_placeholder': 'Device Name Placeholder',
    'decoded_flow_count': 'Decoded Flow Count',
    'milliseconds': 'Milliseconds',
    'delay': 'Delay',
    'Start date required': 'Start date required',
    'Start date and end date can not be same': 'Start date and end date can not be same',
    'Start date should not be grater than end date': 'Start date should not be grater than end date',
    'community_Delete_Msg': 'Are you sure you want to delete community?',
    'Bsp_Default_community_Logo': 'Default Community Image',
    //  new
    'Jobs': 'Jobs',
    'At least one migration profile must be created before starting a new migration.': 'At least one migration profile must be created before starting a new migration.',
    'To create a migration profile, navigate to the Profiles tab.': 'To create a migration profile, navigate to the Profiles tab.',
    ...
    'H248 Termination ID': 'H248 Termination ID',
    'CMS Report (.csv)': 'CMS Report (.csv)',
    'No file selected': 'No file selected',
    'Edit Migration': 'Edit Migration',
    abortMigrationmsg: function (migrationName) {
      return `You are about to abort the migration of <b>“${migrationName}”.</b> Only services that have completed migration will be provisioned in Operations Cloud.`
    },
    undotMigrationmsg: function (migrationName) {
      return `You are about to undo the migration of <b>“${migrationName}”.</b> This will delete the services that have completed migration.`
    },
    deleteMigrationmsg: function (migrationName) {
      return `You are about to delete the job report of <b>“${migrationName}”.</b> The services that have completed migration will not be affected.`
    },
    ...
    'Configure Migration Parameters': 'Configure Migration Parameters',
    'identify appropriate Service Definition Template migrate': 'The below parameters will be used to identify the appropriate Service Definition Template that the ONT services will migrate to.',
    'will be mapped to the selected Service Definition Template.': 'ONT services with matching migration parameters will be mapped to the selected Service Definition Template.',
    'Choose Service Definition Template': 'Choose Service Definition Template',
    'Tag Action': 'Tag Action',
    'VoIP Protocol': 'VoIP Protocol',
    Reset_BSP_Information_Msg: 'You must first delete all Communities before resetting BSP Information.',
    'Do you want to proceed with the dissociate device?': 'Do you want to proceed with the disassociate  system?',
    'Affected Ports': 'Affected Ports',
    'Ranking based on upstream usage': 'Ranking based on upstream usage',
    'Top 5 ONTs': 'Top 5 ONTs',
    'Total Octets': 'Total Octets',
    'Total Packets': 'Total Packets',
    'Only .csv format is supported (Maximum 1000 users)': 'Only .csv format is supported (Maximum 1000 users)',
    'Upstream or downstream DSL Capacity Utilization(%)': 'Upstream or downstream DSL Capacity Utilization(%)',
    'Upstream or downstream DSL current rate comparing to attainable rate(%)': 'Upstream or downstream DSL current rate comparing to attainable rate(%)',
    'Upstream or downstream DSL actual SNR comparing to target SNR': 'Upstream or downstream DSL actual SNR comparing to target SNR',
    'This will disable their access to this community': 'This will disable their access to this community',
    range: 'range',
    missing: 'missing',
    invalid: 'invalid',
    'Delete Community User Access': 'Delete Community User Access',
    'Remove_Community_access': (name, email) => `Are you sure to remove all access to the community for <strong>${name} (${email})</strong>?`,
    'Duplicate users will be removed upon upload': 'Duplicate users will be removed upon upload',
    'PrimaryAndPOSNetwork': 'Primary & Point of Sale Networks',
    'No Restrictions': 'No Restrictions',
    'Very Restrictive': 'Very Restrictive',
    'Moderately Restrictive': 'Moderately Restrictive',
    'Mildly Restrictive': 'Mildly Restrictive',
    "Restrict access to specific content or select pre-set restrictions": "Restrict access to specific content or select pre-set restrictions",
    'Opt-in status is updated once a day.': 'Opt-in status is updated once a day.',
    'Recipient': 'Recipient',
    'Opt-In Status': 'Opt-In Status',
    'View Provisioned Subscribers': 'View Provisioned Subscribers',
    'Chatbot': 'Chatbot',
    'Enablement in progress': 'Enablement in progress',
    'Chatbot enabled': 'Chatbot enabled',
    'Delete Chatbot': 'Delete Chatbot',
    'Set Up': 'Set Up',
    'Chatbot_Info_Message': 'Enter the Chatbot host URL and click “Save Changes” on the top right to start the enablement process. This process may take up to six hours. Once enabled, you can download the code snippet to complete installation.',
    'Chatbot Host URL': 'Chatbot Host URL',
    'Customization': 'Customization',
    'Customization_Msg': 'Customize the Chatbot popup window. You won’t be able to make changes after the chatbot has been enabled.',
    'Chatbot Name': 'Chatbot Name',
    'Logo URL': 'Logo URL',
    'Header Background Color': 'Header Background Color',
    'Window Background Color': 'Window Background Color',
    'Message Text Color': 'Message Text Color',
    'Chatbot Message Bubble Color': 'Chatbot Message Bubble Color',
    'Customer Message Bubble Color': 'Customer Message Bubble Color',
    'Are you sure you want to delete chatbot?': 'Are you sure you want to delete chatbot?',
    'The chatbot will be disabled and all configuration and customization settings will be erased.': 'The chatbot will be disabled and all configuration and customization settings will be erased.',
    'Download Code Snippet': 'Download Code Snippet',
    'Please enter the Chatbot Host URL.': 'Please enter the Chatbot Host URL.',
    'Please enter the Chatbot Name.': 'Please enter the Chatbot Name.',
    'Method': 'Method',
    'selectedMailchimpDataLang': (selectedSegmentData) => `<b>${selectedSegmentData}</b> will be deployed as 2 audience lists, <b>${selectedSegmentData} — Email Only and ${selectedSegmentData} — Direct Mail Only.</b> <br> The use of contacts in the <b>${selectedSegmentData} - Direct Mail Only</b> audience list is permitted soley for Direct Mail and cannot be used for Email.`,
    'Current migration must complete before starting a new migration': 'Current migration must complete before starting a new migration',
    'Start Migration': 'Start Migration',
    'Abort': 'Abort',
    'There are no migrations.': 'There are no migrations.',
    'The migration description shall not exceed 200 characters': 'The migration description shall not exceed 200 characters',
    'New Migration': 'New Migration',
    'Aborted': 'Aborted',
    'Upload Date': 'Upload Date',
    'Completion Date': 'Completion Date',
    'Enable IPFIX': 'Enable IPFIX',
    'Disable IPFIX': 'Disable IPFIX',
    'IPFIX Enabled Successfully': 'IPFIX Enabled Successfully',
    'IPFIX Disabled Successfully': 'IPFIX Disabled Successfully',
    'Secondary admin has not been added in CommandIQ': 'Secondary admin has not been added in CommandIQ',
    'Secondary admin has not been added in CommandWorx': 'Secondary admin has not been added in CommandWorx',
    'PastMonths': {
      'Past 1 month': 'Past 1 month',
      'Past 2 months': 'Past 2 months',
      'Past 3 months': 'Past 3 months',
      'Past 4 months': 'Past 4 months',
      'Past 5 months': 'Past 5 months',
      'Past 6 months': 'Past 6 months',
      'Past 7 months': 'Past 7 months',
      'Past 8 months': 'Past 8 months',
      'Past 9 months': 'Past 9 months',
      'Past 10 months': 'Past 10 months',
      'Past 11 months': 'Past 11 months',
      'Past 12 months': 'Past 12 months',
    },
    'Time_Range': 'Time Range',
    'Affected Interfaces': 'Affected Interfaces',
    'Configured DSL Interfaces': 'Configured DSL Interfaces',
    'DSL Interfaces in Showtime Status': 'DSL Interfaces in Showtime Status',
    'DSL Interface Count': 'DSL Interface Count',
    'Export Subscribers': 'Export Subscribers',
    'Deletion in progress': 'Deletion in progress',
    'deletion_info_msg': 'The chatbot will be disabled and all configuration and customization settings will be erased. The deletion progress may take up to six hours to complete.',
    To_delete_this_community_msg: 'To delete this community, you must first remove it from the workflow(s) listed above',
    VerifyCommunityTitle: 'This community is currently being used in the following workflows',
    'Detected IP Address': 'Detected IP Address',
    'Child': 'Child',
    'Pre-Teen': 'Pre-Teen',
    'Teen': 'Teen',
    'Duplicate users will be appended upon upload': 'Duplicate users will be appended upon upload',
    'flow_timing': 'Flow Timing',
    'Individual profile passwords are set in CommandWorx': 'Individual profile passwords are set in CommandWorx',
    'Staff-Individual': 'Staff-Individual  Password',
    'Staff-Shared Password': 'Staff-Shared Password',
    'Unknown (Last state UP)': 'Unknown (Last state UP)',
    migrationProfile: function (profile) {
      return ` To create a migration profile, navigate to the${profile}`
    },
    'Profiles tab': 'Profiles tab',
    'Video Service Profile': 'Video Service Profile',
    'flow_last': 'flows last',
    'Create Group Member': 'Create Group Member',
    'Create Application Group Member': 'Create Application Group Member',
    'Please enter a Header Background Color': 'Please enter a Header Background Color.',
    'Please enter a Window Background Color': 'Please enter a Window Background Color.',
    'Please enter a Message Text Color': 'Please enter a Message Text Color.',
    'Please enter a Chatbot Message Bubble Color': 'Please enter a Chatbot Message Bubble Color.',
    'Please enter a Customer Message Bubble Color': 'Please enter a Customer Message Bubble Color.',
    OUI_Info_Msg: "Enter OUI in the format AB:CD:EF. If more than one OUI is needed, click Add. A maximum of 32 OUIs are allowed",
    'Stats': 'Stats',
    'Call Stats': 'Call Stats',
    'SIP Stats': 'SIP Stats',
    'RTP Stats': 'RTP Stats',
    'The_max_number_of_allowed_communities_is_10': 'The max number of allowed communities is 8.',
    'Please enter a valid Upload URL': 'Please enter a valid Upload URL',
    'Please enter a valid Download URL': 'Please enter a valid Download URL',
    CONNECTED: "CONNECTED",
    ...
    SYNCHRONIZE_IN_PROGRESS: "SYNCHRONIZE IN PROGRESS",
    'Force Sync Completed': "Force Sync Completed",
    ...
    "Time in DSL Status": "Time in DSL Status",
    "retrainCount": "DSL Retrain Count",
    "retrainReason": "DSL Retrain Reason",
    "actualPsdMask": "Power Spectrum Density Mask",
    "transmissionMode": "Transmission Mode",
    "vectorMode": "Vector Mode",
    "lineVectorState": "Line Vectoring State",
    "powerSaveTimeRemaining": "Power Save Time Remaining",
    "dsTransmitPower": "Downstream Transmit Power",
    "dsLoopAttenuation": "Downstrean Loop Attenuation",
    "usTransmitPower": "Upstream Transmit Power",
    "usLoopAttenuation": "Upstream Loop Attenuation",
    "Zip": "Zip",
    "Ready": "Ready",
    "Unprocessed": "Unprocessed",
    'Network Services updated successfully': 'Network Services updated successfully',
    "UNKNOWN": "UNKNOWN",
    'An unknown error has occurred. Refresh the page to try again': 'An unknown error has occurred. Refresh the page to try again',
    'appropriate Service Definition': 'The below parameters will be used to identify the appropriate Service Definition Template that the RG services will migrate to.',
    'Service Profile Parameters': 'Service Profile Parameters',
    'EXOS-Powered GigaSpire': 'EXOS-Powered GigaSpire',
    'IPv4 Only': 'IPv4 Only',
    'IPv6 Only': 'IPv6 Only',
    'IPv6 Rapid Deployment (IPv6 via IPv4, aka 6rd)': 'IPv6 Rapid Deployment (IPv6 via IPv4, aka 6rd)',
    'IPv6 + IPv4 Dual-Stack': 'IPv6 + IPv4 Dual-Stack',
    'Total Number of Multicast Filter Entries': 'Total Number of Multicast Filter Entries',
    'Range Name': 'Range Name',
    'Range End': 'Range End',
    'Default VLAN': 'Default VLAN',
    'Range VLAN': 'Range VLAN',
    'RG services with matching migration parameters will be mapped to the selected Service Definition Template.': 'RG services with matching migration parameters will be mapped to the selected Service Definition Template.',
    'Download CIR': 'Download CIR',
    'Upload CIR': 'Upload CIR',
    'GigaCenter & GigaHub & GigaSpire(GS4227E,GS4220E,GS4227,GS4227W,GS4237)': 'GigaCenter & GigaHub & GigaSpire(GS4227E,GS4220E,GS4227,GS4227W,GS4237)',
    'Range Start': 'Range Start',
    'Are you sure you want to update the Staff SSID?': 'Are you sure you want to update the Staff SSID?',
    'Open Operations Cloud': 'Open Operations Cloud',
    'Service Migration Profile': 'Service Migration Profile',
    'Multicast Filter Name': 'Multicast Filter Name',
    'Multicast Range Name': 'Multicast Range Name',
    'Multicast Range Start': 'Multicast Range Start',
    'Multicast Range End': 'Multicast Range End',
    'Total Number of Multivlan Range Filters': 'Total Number of Multivlan Range Filters',
    'Multivlan Range End': 'Multivlan Range End',
    'Multivlan Range Start': 'Multivlan Range Start',
    'Total Service Disruptions': 'Total Service Disruptions',
    'Report Time': 'Report Time',
    'Account No': 'Account No',
    'Add to Favorites': 'Add to Favorites',
    'Remove from Favorites': 'Remove from Favorites',
    'Favorite Endpoints': 'Favorite Endpoints',
    'No endpoint favorites added': 'No endpoint favorites added',
    'There are no endpoint favorites added': 'There are no endpoint favorites added',
    'Manage Favorite Endpoints': 'Manage Favorite Endpoints',
    'Manage Endpoint Favorites': 'Manage Endpoint Favorites',
    'Use filter preset': 'Use filter preset',
    'No filter presets saved': 'No filter presets saved',
    'Save as filter preset': 'Save as filter preset',
    'View all filter presets': 'View all filter presets',
    'Filter Presets': 'Filter Presets',
    'There are no filter presets saved.': 'There are no filter presets saved.',
    'Maximum number of filter presets reached.': 'Maximum number of filter presets reached.',
    'Maximum number of Endpoint Favorites reached.': 'Maximum number of Endpoint Favorites reached.',
    'Match Parameters': 'Match Parameters',
    'New Disruptions on': 'New Disruptions on',
    'PON Status': 'PON Status',
    'Last Modified': 'Last Modified',
    'Subscribers affected by ONT or PON Alarms': 'Subscribers affected by ONT or PON Alarms',
    'Select a day to view Subscribers affected by ONT or PON Alarms for that day.': 'Select a day to view Subscribers affected by ONT or PON Alarms for that day.',
    'Alert Type': 'Alert Type',
    'Select an alert type count to view the alarms for that alert type.': 'Select an alert type count to view the alarms for that alert type.',
    '% of Alarms': '% of Alarms',
    'Loss of PON Alarms': 'Loss of PON Alarms',
    'Select a day to view Loss of PON Alarms for that day.': 'Select a day to view Loss of PON Alarms for that day.',
    filter_presets_info: function (length) {
      return `${length} of 10 filter presets saved`
    },
    'Delete Software Image(s)': 'Delete Software Image(s)',
    'Are you sure you want to delete the following software image(s):': 'Are you sure you want to delete the following software image(s):',
    'Outdated Image Alert': 'Outdated Image Alert',
    'recommended_to_set_the_image': 'It is recommended to set the image alert to 2 releases. Software images older than 2 releases are not officially supported by Calix.',
    'Receive GigaSpire Alert After': 'Receive GigaSpire Alert After',
    'Releases': 'Releases',
    'Receive GigaCenter Alert After': 'Receive GigaCenter Alert After',
    'Save Alert Settings': 'Save Alert Settings',
    'Please enter version value more than 2': 'Please enter version value more than 2',
    'Please enter alert value between 1 to 10': 'Please enter alert value between 1 to 10',
    'Swap in Progress': 'Swap in Progress',
    'Policy Route Service': 'Policy Route Service',
    ...
    'There are no endpoint favorites added.': 'There are no endpoint favorites added.',
    'Total AE ONTs': 'Total AE ONTs',
    'Total Ethernet Interfaces': 'Total Ethernet Interfaces',
    'Active Interfaces': 'Active Interfaces',
    'Routed on Secondary VLAN Mode': 'Routed on Secondary VLAN Mode',
    'Routed on Secondary VLAN Service': 'Routed on Secondary VLAN Service',
    'Bridge Mode': 'Bridge Mode',
    'Route Mode': 'Route Mode',
    'Search Segments': 'Search Segments',
    'Please enter alert value below or equal to 10': 'Please enter alert value below or equal to 10',
    'India Standard Time': 'India Standard Time',
    abortMigrationmsgfou: function (migrationName) {
      return `You are about to abort the migration of <b>“${migrationName}”.</b> Only services that have completed migration will be provisioned in Deployment Cloud.`
    },
    'General Speed Test': 'General Speed Test',
    'CAF-II Speed Test': 'CAF-II Speed Test',
    'Third-Party CPE': 'Third-Party CPE',
    'Calix Speed Test/Ookla': 'Calix Speed Test/Ookla',
    'Speed Test Type': 'Speed Test Type',
    'Ookla': 'Ookla',
    'Calix Speed Test': 'Calix Speed Test',
    'Test Configuration for Ookla Capable CPE': 'Test Configuration for Ookla Capable CPE',
    'Only Use Ookla Private Server for Gigaspire Speed Test': 'Only Use Ookla Private Server for Gigaspire Speed Test',
    'Daily Background Speed Test': 'Daily Background Speed Test',
    'Speed test between Ookla': 'Speed test between Ookla-capable CPE and Ookla public servers does not require specific configuration',
    'Performance Test': 'Performance Test',
    'Calix speed test server and Ookla private server': 'Ookla public servers are used for speed tests by default. This page enables the set up of Calix speed test server and Ookla private server.',
    'Test Configuration for Speed Test Server': 'Test Configuration for Speed Test Server',
    'Speed Test Server': 'Speed Test Server',
    'Smart Speed Test': 'Smart Speed Test',
    'Copy Configuration From Third-Party CPE': 'Copy Configuration From Third-Party CPE',
    'Upload Size (Bytes)': 'Upload Size (Bytes)',
    'Re-try with Ookla on Failure': 'Re-try with Ookla on Failure',
    'Currently using the Public Ookla server': 'Currently using the Public Ookla server',
    'Test Configuration for Private Ookla Server': 'Test Configuration for Private Ookla Server',
    'Private Speed Test': 'Private Speed Test',
    'On demand speed test configuration for third-party CPE devices': 'On demand speed test configuration for third-party CPE devices',
    'TR-143 Server Configuration': 'TR-143 Server Configuration',
    'Web Path': 'Web Path',
    'Please enter a valid Web Path.': 'Please enter a valid Web Path.',
    'Central Daylight Time': 'Central Daylight Time',
    'Central Standard Time': 'Central Standard Time',
    'Provision ONT Services': 'Provision ONT Services',
    'Select up to 10': 'Select up to 10',
    'Maximum selection of 10 reached': 'Maximum selection of 10 reached',
    'Onboarded Date': 'Onboarded Date',
    'Recording deleted successfully': 'Recording deleted successfully',
    'Filtering by Application is not allowed when the Application Group filter is active': 'Filtering by Application is not allowed when the Application Group filter is active',
    'Application Id or Application Group Id is required': 'Application Id or Application Group Id is required',
    'Application Groups Traffic': 'Application Groups Traffic',
    'Invalid email syntax': 'Invalid email syntax',
    'Subcriber can only have upto 8 communities': 'Subcriber can only have upto 8 communities',
    'is not available': 'is not available',
    'Empty value in “Community Name” column': 'Empty value in “Community Name” column',
    'Empty value in “Email” column': 'Empty value in “Email” column',
    'Empty value in “Last Name” column': 'Empty value in “Last Name” column',
    'Empty value in “First Name” column': 'Empty value in “First Name” column',
    'Routed on HSI VLAN': 'Routed on HSI VLAN',
    'Routed on Separate VLAN': 'Routed on Separate VLAN',
    'Software Alert should not be in Decimal': 'Software Alert should not be in Decimal',
    'Filtering by Application Group is not allowed when the Application filter is active': 'Filtering by Application Group is not allowed when the Application filter is active',
    'Force Sync Initiated': 'Force Sync Initiated',
    'Force Sync In Progress': 'Force Sync In Progress',
    'Force Sync Error': 'Force Sync Error',
    'Force Sync Timeout Error': 'Force Sync Timeout Error',
    'Swapped Systems': 'Swapped Systems',
    'Subnet Conflict': 'Conflict: Subnet overlaps with existing range. Please review your subnet configuration and contact Calix Support if no overlap can be identified.',
    'Open Service Cloud': 'Open Service Cloud',
    'ASM Server Status': 'ASM Server Status',
    'ASM Name': 'ASM Name',
    'IF Name': 'IF Name',
    'Interface Type': 'Interface Type',
    'RG Mac Address': 'RG MAC Address',
    'First Sign of Life': 'First Sign of Life',
    'PPPoE Subscriber': 'PPPoE Subscriber',
    'PCRF specified URL Redirect Policy': 'PCRF Specified URL Redirect Policy',
    'PCRF specified Redirect URL': 'PCRF Specified Redirect URL',
    'Multicast Service': 'Multicast Service',
    'Multicast Service State': 'Multicast Service State',
    'GX Fuction': 'GX Function',
    'GX Session State': 'GX Session State',
    'Accounting Fuction': 'Accounting Function',
    'Allocated IPV4 Addresses': 'Allocated IPv4 Addresses',
    'v4 Lease Time': 'v4 Lease Time',
    'v6 Link Local Address': 'v6 Link Local Address',
    'Allocated IPV6 Address': 'Allocated IPv6 Address',
    'Allocated IPV6 Prefix': 'Allocated IPv6 Prefix',
    'IPV6 Lease Time': 'IPv6 Lease Time',
    'Last Deactivation Cause': 'Last Deactivation Cause',
    'Applied Policy Map': 'Applied Policy Map',
    deployToChannels: (channel) => {
      return `Will be deployed to ${channel} when you click "Deploy Campaign".`
    },
    deployToChannelsInModal: (channel, attributes) => {
      return `Segment ${attributes} will be sent to ${channel}. This action may take up to 60 minutes`
    },
    'attributes': 'and attributes',
    'Required attributes (Name, Service Address, Email, Phone) will always be sent.': 'Required attributes (Name, Service Address, Email, Phone) will always be sent.',
    'Select additional attributes to send for personalization.': 'Select additional attributes to send for personalization.',
    'Select All': 'Select All',
    'Deselect All': 'Deselect All',
    'Electronic Content Builder can help you to design your collateral.': 'Electronic Content Builder can help you to design your collateral.',
    'Include additional Direct Mail Only audience list': 'Include additional Direct Mail Only audience list',
    'Segment will be sent to Facebook. This action may take up to 60 minutes': 'Segment will be sent to Facebook. This action may take up to 60 minutes',
    'Sync Date': 'Sync Date',
    'Personalization not available (only targeting attributes will be sent).': 'Personalization not available (only targeting attributes will be sent).',
    'Systems Swapped': 'Systems Swapped',
    'Show ASM service information if provisioned with SMx': 'Show ASM service information if provisioned with SMx',
    "On-demand Speed Test using public Ookla Servers isn't available for this country": "On-demand Speed Test using public Ookla Servers isn't available for this country",
    'Static Endpoints': 'Static Endpoints',
    'Audience Sync Details': 'Audience Sync Details',
    'All Channels': 'All Channels',
    'Mobile Notification': 'Mobile Notification',
    'Attributes': 'Attributes',
    'Data Example': 'Data Example',
    deployToCsvInModal: (attributes) => {
      return `Segment ${attributes} will be made available in CSV file download`
    },
    Member_ports: 'Member Ports',
    'A CommandIQ download link will be sent to the subscriber via the following email address': 'A CommandIQ download link will be sent to the subscriber via the following email address',
    'CommandIQ Invite': 'CommandIQ Invite',
    'Update Email': 'Update Email',
    'Send Invite': 'Send Invite',
    'Send CommandIQ Invite': 'Send CommandIQ Invite',
    'FSAN/MAC Address/Serial Number/RegID/Subscriber Name/Subscriber Account': 'FSAN/MAC Address/Serial Number/RegID/Subscriber Name/Subscriber Account',
    'Old MAC Address': 'Old MAC Address',
    'Old FSAN': 'Old FSAN',
    'Old Registration Id': 'Old Registration Id',
    'New System Id': 'New System Id',
    'Swap Time': 'Swap Time',
    'Old System Last Inform Time': 'Old System Last Inform Time',
    'Active System Alarms': 'Active System Alarms',
    'Select a severity to view active system alarms of that severity': 'Select a severity to view active system alarms of that severity',
    'Service Disruption Notifications': 'Service Disruption Notifications',
    'New Service Disruption': 'New Service Disruption',
    'Additional Notes': 'Additional Notes',
    'CommandIQ Invite Sent': 'CommandIQ Invite Sent',
    'The invite email was successfully sent to the subscriber': 'The invite email was successfully sent to the subscriber',
    'Operational Speed': 'Operational Speed',
    'Wi-Fi Configurations msg new': 'Existing Wi-Fi configurations and other settings cannot be applied to the replacement system if the current system is offline. Do you wish to continue?',
    'Provision ONT Service':'Provision ONT Service',
    'Ask the subscriber to verify some of the following information before sending CommandIQ email invite':'Ask the subscriber to verify some of the following information before sending CommandIQ email invite',
    'Send CommandIQ Invite Email':'Send CommandIQ Invite Email',
    'TCP Server Test':'TCP Server Test',
    'UDP Server Test':'UDP Server Test',
    'TCP System Test':'TCP System Test',
    'UDP System Test':'UDP System Test',
    'Ookla Test':'Ookla Test',
    'RG Service Profile':'RG Service Profile',
