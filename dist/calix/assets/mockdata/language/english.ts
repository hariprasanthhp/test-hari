export const ENGLISH = {
    ...
    experienceiq_protectiq_report_ar: 'edge-iq-suite-subscribers',
    ...
    adoption_Chart: 'Edge IQ Suite Subscribers',
    ...
    revenue_edge_suite_Chart: 'Revenue EDGE Suite Trending',
    ...
    Heat_Map_ShowInfo:
        'A heatmap of subscribers by social channels, enabling you to determine which social channel and time of day is best to target for maximum return in marketing spend.',
    ...
    'Text must be under 256 characters': 'Text must be under 256 characters',
    Outbound: 'Outbound',
    Inbound: 'Inbound',
    new: 'New',
    ...
    THERMAL_HIGH_Description: 'The subscribers experience might be affected by high operational temperature shortening life span, ask them about placement and if it is in direct sun light, have them move it.',
    THERMAL_TOO_HIGH_Reason: 'Very High Operating Temperature Observed.',
    THERMAL_TOO_HIGH_Description: 'The subscribers experience might be affect by very high operational temperature shortening life span, ask them about placement and if it is in direct sun light, have them move it.',
    ...
    factoryResetTitle: (input, product) => {
        return ['GS', 'GM', 'GC', '844', '854', '836'].filter(obj => input.includes(obj)).length || ['GigaSpire', 'GigaMesh', 'GigaPoint', 'GigaPro'].includes(product) ? 'Restore Default' : 'Factory Reset';
        //input.includes('GS') || input.includes('GC') || input.includes('844E') || input.includes('854') || input.includes('836') || input.includes('GM')
    },
    FactoryResetInfoBasedOnModel: function (input, product) {
        return `${this.factoryResetTitle(input, product)} will erase the configuration on the service Gateway and will attempt to restore the configuration from Calix Cloud. This may take up to 10 mins.`
    },
