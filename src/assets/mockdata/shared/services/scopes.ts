export const SCOPES: any = {
    ...
    "cloud.rbac.coc.insights.networktrends": [
        "read"
    ],
    ...
    "cloud.rbac.coc.insights.networktrends.activepons": [
        "read"
    ],
    ...
    "cloud.rbac.csc.wifi.basic": ["write"],
    ...
    "cloud.rbac.csc.calloutcome.createview": [
        "read",
        "write"
    ],
    ...
    "cloud.rbac.coc.insights.networktrends.subscriberimpacted": [
        "read"
    ],
    ...
    "cloud.rbac.coc.systems.network.nwdelete": [
        "read",
        "write"
    ],
    ...
    "cloud.rbac.coc.systems.network.nwdisconnect": [
        "read",
        "write"
    ],
    ...
    "cloud.rbac.csc.search.onboardedemaladdr": [
        "read",
        "write"
    ],
