...
import { ProfileReportWorkflow } from './profile-report-workflow';
...
export class AddComponent implements OnInit {
  ...
  Onsave(){
    ...
    let params=this.FormData?.profile;
     ...
     if(params.deviceType==='RG' && params?.serviceType==='DATA'){
      ...
      delete params.voiceSIPProfile
      delete params.voiceTDMGWProfile
     }else  if(params.deviceType==='RG' &&params?.serviceType==='VIDEO'){
      ...
      delete params.voiceSIPProfile
      delete params.voiceTDMGWProfile
     }else if(params.deviceType==='RG' &&params?.serviceType==='VOICE'){
      delete params.dataProfile
      delete params.videoProfile
