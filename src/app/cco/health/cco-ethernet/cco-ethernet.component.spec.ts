...
import { Locations, Regions, Systems, Interfaces } from 'src/assets/mockdata/shared/rls.data';
import { of } from 'rxjs';

import { CcoEthernetComponent } from './cco-ethernet.component';


describe('CcoEthernetComponent', () => {
  let component: CcoEthernetComponent;
  let fixture: ComponentFixture<CcoEthernetComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [CcoEthernetComponent],
      imports: [
        RouterTestingModule, 
      ...
      .compileComponents()
      .then(() => {
        fixture = TestBed.createComponent(CcoEthernetComponent);
