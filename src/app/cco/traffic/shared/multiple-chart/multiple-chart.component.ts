...
export class MultipleChartComponent implements OnInit {
  ...
  multipleStreamSubscription: Subscription;
  ...
  getRtData() {
    ...
    this.multipleStreamSubscription = this.webSocketService.multipleRatePacketStreamData$.subscribe((cdata: any) => {
    ...
    this.streamSubscription = this.webSocketService.multipleStreamData$.subscribe((data: any) => {
  ...
  removeReplayOldKeys(lastChartDataObj, chartName): void {
