...
describe('TrafficComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [
        CustomTranslateService, SsoAuthService, CommonService, NetworkReportApiService, ChartOptionsService
      ]
    })
      .compileComponents()
      .then(() => {
  ...
  it('should render the usage chart', () => {
    spyOn(networkReportService, 'getTraffic').and.returnValue(of(Traffic))
  ...
  it('should render the usage chart1', () => {
    spyOn(networkReportService, 'getTraffic').and.returnValue(throwError({ error: { title: 'defined' } }))
