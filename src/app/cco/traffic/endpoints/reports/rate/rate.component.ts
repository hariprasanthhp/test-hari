...
export class RateComponent implements OnInit {
  ...
  constructor(
    ...
    private apiService: EndpointReportsService,
    private optionsService: ChartOptionsService,
  ...
  loadChartData(data: any) {
    ...
    //this.Highcharts.chart('container', {}).destroy();
    this.subscribe = this.apiService.getRate(data, endpointId).subscribe((res: any) => {
      this.data = res;
      this.optionsService.btnDisabled = false;
      this.trafficChartOptions = this.optionsService.makeOptionsForEPLineChart(res, data);
  ...
  renderChart() {
    this.trafficChartOptions = null;
    this.trafficChartOptions = this.optionsService.makeOptionsForEPLineChart(this.data, this.filters);
    this.Highcharts.chart('container', this.trafficChartOptions);
  }
