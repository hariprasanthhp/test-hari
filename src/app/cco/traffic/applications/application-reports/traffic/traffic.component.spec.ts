...
describe('TrafficComponent', () => {
  ...
  let applicationReportApiService: ApplicationReportApiService;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      .compileComponents()
      .then(() => {
        applicationReportApiService = TestBed.inject(ApplicationReportApiService);
  ...
  it('should render the usage chart', () => {
    spyOn(applicationReportApiService, 'getTraffic').and.returnValue(of(Traffic))
  ...
  it('should render the usage chart1', () => {
    spyOn(applicationReportApiService, 'getTraffic').and.returnValue(throwError({ error: { title: 'defined' } }))
    params['criteriaSelected'] = 'usage';
    component.loadChartData(params);
