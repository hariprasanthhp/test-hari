...
export class TopApplicationsComponent implements OnInit {
  ...
  loadChartData(data: any) {
    ...
    this.subscribe = this.service.TopApplication(data, 'top-applications').subscribe((res: any) => {
      ...
      this.chartHeight = this.height.toString() + "px";
      setTimeout(() => {
        this.topAppsChartOptions = this.options.makeOptionsForApplications(res, 'bar', data, 'locations');
      ...
      this.topAppsChartOptions = this.options.makeOptionsForApplications([], 'bar', data, 'locations');
      if(document.getElementById('container')){
        this.Highcharts.chart('container', this.topAppsChartOptions);
      }
  ...
  renderChart() {
    this.topAppsChartOptions = null;
    this.topAppsChartOptions = this.options.makeOptionsForApplications(this.data, 'bar', this.filters, 'locations');
    if(document.getElementById('container')){
      this.Highcharts.chart('container', this.topAppsChartOptions);
    }
  }
