...
import { MarketingChannelHubspotComponent } from './marketing-channel-hubspot.component';
...
describe('MarketingChannelHubspotComponent', () => {
  let component: MarketingChannelHubspotComponent;
  let fixture: ComponentFixture<MarketingChannelHubspotComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [MarketingChannelHubspotComponent],
      ...
      .compileComponents().then(()=>{
        fixture = TestBed.createComponent(MarketingChannelHubspotComponent);
  ...
  it('should get MailChimp Token', () => {
    ...
    expect((component as any).sso.setValidHubSpotAuth).toHaveBeenCalledOnceWith(true);
