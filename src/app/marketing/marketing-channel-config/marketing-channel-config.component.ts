...
@Component({
  selector: 'app-marketing-channel-config',
  templateUrl: './marketing-channel-config.component.html',
  styleUrls: ['./marketing-channel-config.component.scss']
})
export class MarketingChannelConfigComponent implements OnInit {
  ...
  getMailChimpToken(): any {
    ...
    this.http.post(`${environment.API_BASE_URL}cmc-mchannel/marketingChannel/authorization`, params).subscribe((json: any) => {
      ...
      this.router.navigate(['/engagement/channels/configuration']);
