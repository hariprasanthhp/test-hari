...
import { MarketingCustomtabComponent } from './marketing-customtab.component';
...
describe('MarketingCustomtabComponent', () => {
  let component: MarketingCustomtabComponent;
  let fixture: ComponentFixture<MarketingCustomtabComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ MarketingCustomtabComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(MarketingCustomtabComponent);
