...
import { of } from 'rxjs';
import { MarketingTriggeredComponent } from './marketing-triggered.component';
...
describe('MarketingTriggeredComponent', () => {
  let component: MarketingTriggeredComponent;
  let fixture: ComponentFixture<MarketingTriggeredComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [RouterTestingModule, HttpClientTestingModule
        , NgSelectModule],
      declarations: [ MarketingTriggeredComponent ],
      ...
      providers: [{
        provide: MarketingCampaignsApiService, useValue: {
          ...
          TriggeredChartSeries_rev: jasmine.createSpy().and.returnValue(of({ data: [] })),
        }
      }, 
      {
      ...
      { provide: TranslateService, useClass: CustomTranslateService },
      {
        ...
        provide: MarketingCampaignsChartServiceService, useValue: {
          ...
          triggered: jasmine.createSpy().and.returnValue(of({})),
        }
      }, { provide: MarketingExploreDataAssignerService, useValue: {} }]

    })
    .compileComponents().then(() => {
      fixture = TestBed.createComponent(MarketingTriggeredComponent);
  ...
  it('should call ChartFinalData', () => {
    ...
    //arrange
    // spyOn((component as any).MarketingCommonService, 'formatMonthForRevCampaignChart').and.returnValue(of(data[0].timestamp));
    spyOn(component, 'passChartOption')
    //set
  ...
  it('should call passChartOption', () => {
    //arrange
    //assert
    component.passChartOption('series', 'categories', 'Revenue', 'val');
  ...
  it('should call passChartOptioncamp', () => {
    //arrange
    //assert
    component.passChartOptioncamp('series', 'categories', 'Revenue', 'from');
  });
  ...
  it('should call download', () => {
    ...
    //arrange
    component.language = { Total_Subscribers: 'Total_Subscribers' };
    component.download();
    //expect
  ...
  it('should call download_camp', () => {
    ...
    //arrange
    component.language = { Campaign_Audience_Size: 'Campaign_Audience_Size' };
