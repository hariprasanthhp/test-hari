...
import { MarketingCampaignsDatasetComponent } from './marketing-campaigns-dataset.component';
...
describe('MarketingCampaignsDatasetComponent', () => {
  let component: MarketingCampaignsDatasetComponent;
  let fixture: ComponentFixture<MarketingCampaignsDatasetComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [MarketingCampaignsDatasetComponent],
      ...
      .compileComponents().then(() => {
        fixture = TestBed.createComponent(MarketingCampaignsDatasetComponent);
