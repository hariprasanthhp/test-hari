...
@Component({
  selector: 'app-add-data-plan',
  templateUrl: './add-data-plan.component.html',
  styleUrls: ['./add-data-plan.component.scss']
})
export class AddDataPlanComponent implements OnInit, OnChanges {
  ...
  PPoE_showHide(){
    this.isPPoE_Hide = !this.isPPoE_Hide;
  }
