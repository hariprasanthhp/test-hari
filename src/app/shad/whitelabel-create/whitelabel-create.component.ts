...
@Component({
  selector: 'app-whitelabel-create',
  templateUrl: './whitelabel-create.component.html',
  styleUrls: ['./whitelabel-create.component.scss'],
  providers: [ColorPickerService]
})
export class WhitelabelCreateComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.titleService.setTitle(`Add CommandIQ Branding - ${this.REDIRECT_URL === 'systemAdministration' ? 'System Administration' : 'Administration'} - Calix Cloud`);
  }
