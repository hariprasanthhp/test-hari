...
export class TopologyComponent implements OnInit {
  ...
  uniqueHostnames: any = [];
  clientData: any = {};
  codelist = ["LATENCY_HIGH", "VIRUS_ATTACK", "CLIENT_DEVICE_LOW_SIGNAL_DETECTED", "CLIENT_DEVICE_LOW_PHY_RATE_DETECTED",
    ...
    "GATEWAY_FAILED", "WAP_FAILED", "SPEED_LOW_75", "SPEED_LOW_75_80", "TRAFFIC_HIGH", "WIFI_INTERFERENCE_HIGH_24G", "WIFI_INTERFERENCE_HIGH_5G", "DS_SPEED_LOW_85", "US_SPEED_LOW_85", "DS_SPEED_LOW_75", "US_SPEED_LOW_75",
    "THERMAL_TOO_HIGH", "THERMAL_HIGH"];
  twoHrsCategory = [
  ...
  constructor(private service: DataServiceService,    private translateService: TranslateService, private http: HttpClient, private route: ActivatedRoute, private spinner: NgxSpinnerService, private ssoAuthService: SsoAuthService, private issuseservice: IssuesService,) {
  ...
  loadfirst() {
    ...
    myDiagram.nodeTemplate =
      ...
      $(go.Shape,{ width: 150, height: 130, margin: 4, fill: null, strokeWidth: 2 } ),        //for circle numbers
        {
          background: "white",
        ...
        $(go.Panel, "Horizontal",  // the row of status indicators
          ...
          $(go.Panel, "Vertical",
          // { width: 70, height: 110 },
          new go.Binding("width", "label", function (l) { return l ? 70 : 0 }),
          new go.Binding("height", "label", function (l) { return l ? 110 : 0 }),
...

            {
              ...
              // new go.Binding("margin", "label", function (l) { return l ? new go.Margin(40, 0, 0, 0) : '' }),
        ...
        // //   new go.Binding("background", "label", function (l) { return l ? 'red' : '' }),
        // //   new go.Binding("padding", "label", function (l) { return l ? 10 : '' }),
    ...
    // //   this.topoGraph(go.Shape, "RoundedRectangle",  // surrounds the Placeholder
    // //     { parameter1: 14,width: 700,
    // //       fill: "rgba(128,128,128,0.33)" }),
    // //   this.topoGraph(go.Placeholder,    // represents the area of all member parts,
  ...
  getData(): void {
    ...
    this.serialNo = this.ssoAuthService.getSerialNo();
    let params = {
      orgId: this.orgId,
      serialNumber: this
    }
    // this.issuseservice.topologyValue(this.orgId, this.serialNo).subscribe((json: any) => {
